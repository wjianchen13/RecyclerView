...
public class FlexboxAdapter extends RecyclerView.Adapter {
    ...
    private List<FlexboxBean> mData;

    public FlexboxAdapter(Context context, List<FlexboxBean> list) {
    ...
    public int getItemViewType(int position) {
        FlexboxBean bean = mData.get(position);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ImageViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_flexbox, parent, false));
    }
