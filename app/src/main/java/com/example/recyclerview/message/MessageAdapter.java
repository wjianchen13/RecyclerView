 ...
 * 测试
 */
public class MessageAdapter extends BaseMultiItemQuickAdapter<TestBean, BaseViewHolder> implements MessageLayoutManager.OnScrollStateChangedDinoListener {
