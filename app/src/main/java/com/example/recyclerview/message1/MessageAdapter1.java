 ...
 * 测试
 */
public class MessageAdapter1 extends BaseMultiItemQuickAdapter<TestBean, BaseViewHolder> implements MessageLayoutManager1.OnScrollStateChangedDinoListener {
    ...
    public MessageAdapter1(Context context, List<TestBean> list, RecyclerView rv) {
        super(list);
