 ...
 * 测试
 */
public class CacheAdapter extends BaseMultiItemQuickAdapter<TestBean, BaseViewHolder> implements CustomLinearLayoutManager.OnScrollStateChangedDinoListener {
    ...
    public CacheAdapter(Context context, List<TestBean> list, RecyclerView rv) {
        super(list);
