package com.example.recyclerview.chat.flow;
...
public class FlowLayoutManager extends RecyclerView.LayoutManager {
    ...
    protected boolean changeLine = false;
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        for (int i = 0; i < getItemCount(); i++) {
            ...
            if (cuLineWidth + childUseWidth <= usedMaxWidth) { // 如果加上当前的item还小于最大的宽度的话
                ...
                totalWidth = cuLineWidth + left + right;
        ...
        totalWidth = changeLine ? getWidth() : totalWidth;
