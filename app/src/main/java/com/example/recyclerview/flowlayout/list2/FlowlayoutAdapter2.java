...
import com.example.recyclerview.flowlayout.list1.UserBadgeView;
 ...
 */
public class FlowlayoutAdapter2 extends BaseMultiItemQuickAdapter<FlowlayoutBean, BaseViewHolder> {

    private Context mContext;

    public FlowlayoutAdapter2(Context context, List<FlowlayoutBean> data) {
        super(data);
        this.mContext = context;
        addItemType(0, R.layout.item_flowlayout_2);
