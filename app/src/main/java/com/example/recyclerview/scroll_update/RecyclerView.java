 ...
 *
 * <ul>
 *     <li><em>Adapter:</em> A subclass of {@link androidx.recyclerview.widget.RecyclerView.Adapter} responsible for providing views
 ...
 * <p>
 * RecyclerView introduces an additional level of abstraction between the {@link androidx.recyclerview.widget.RecyclerView.Adapter} and
 * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager} to be able to detect data set changes in batches during a layout
 ...
 * layout calculation (e.g. {@link androidx.recyclerview.widget.RecyclerView.ViewHolder#getLayoutPosition()},
 ...
 * <code>*AdapterPosition*</code>. (e.g. {@link androidx.recyclerview.widget.RecyclerView.ViewHolder#getAbsoluteAdapterPosition()},
 ...
 * {@link androidx.recyclerview.widget.RecyclerView.ViewHolder#getBindingAdapterPosition()}. Beware that these methods may not be able to
 * calculate adapter positions if {@link androidx.recyclerview.widget.RecyclerView.Adapter#notifyDataSetChanged()} has been called and new
 ...
 * <p>
 * When writing a {@link androidx.recyclerview.widget.RecyclerView.LayoutManager} you almost always want to use layout positions whereas when
 * writing an {@link androidx.recyclerview.widget.RecyclerView.Adapter}, you probably want to use adapter positions.
 * <p>
...
public class RecyclerView extends ViewGroup implements ScrollingView,
    ...
    private final androidx.recyclerview.widget.RecyclerView.RecyclerViewDataObserver mObserver = new androidx.recyclerview.widget.RecyclerView.RecyclerViewDataObserver();

    final androidx.recyclerview.widget.RecyclerView.Recycler mRecycler = new androidx.recyclerview.widget.RecyclerView.Recycler();
    ...
    final List<androidx.recyclerview.widget.RecyclerView.RecyclerListener> mRecyclerListeners = new ArrayList<>();
    final ArrayList<androidx.recyclerview.widget.RecyclerView.ItemDecoration> mItemDecorations = new ArrayList<>();
    private final ArrayList<androidx.recyclerview.widget.RecyclerView.OnItemTouchListener> mOnItemTouchListeners =
            new ArrayList<>();
    ...
    private List<androidx.recyclerview.widget.RecyclerView.OnChildAttachStateChangeListener> mOnChildAttachStateListeners;
     ...
     * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#onItemsChanged(androidx.recyclerview.widget.RecyclerView)} should be called during the subsequent
     * measure/layout.
     *
     * @see #processDataSetCompletelyChanged(boolean)
     */
    ...
    @NonNull
    private androidx.recyclerview.widget.RecyclerView.EdgeEffectFactory mEdgeEffectFactory = new androidx.recyclerview.widget.RecyclerView.EdgeEffectFactory();
    private EdgeEffect mLeftGlow, mTopGlow, mRightGlow, mBottomGlow;

    androidx.recyclerview.widget.RecyclerView.ItemAnimator mItemAnimator = new DefaultItemAnimator();
    ...
    final androidx.recyclerview.widget.RecyclerView.ViewFlinger mViewFlinger = new androidx.recyclerview.widget.RecyclerView.ViewFlinger();

    GapWorker mGapWorker;
    GapWorker.LayoutPrefetchRegistryImpl mPrefetchRegistry =
            ALLOW_THREAD_GAP_WORK ? new GapWorker.LayoutPrefetchRegistryImpl() : null;

    final androidx.recyclerview.widget.RecyclerView.State mState = new androidx.recyclerview.widget.RecyclerView.State();

    private androidx.recyclerview.widget.RecyclerView.OnScrollListener mScrollListener;
    private List<androidx.recyclerview.widget.RecyclerView.OnScrollListener> mScrollListeners;
    ...
    private androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemAnimatorListener mItemAnimatorListener =
            new androidx.recyclerview.widget.RecyclerView.ItemAnimatorRestoreListener();
     ...
     */
    @VisibleForTesting
    final List<androidx.recyclerview.widget.RecyclerView.ViewHolder> mPendingAccessibilityImportanceChange = new ArrayList<>();
    ...
    private final ViewInfoStore.ProcessCallback mViewInfoProcessCallback =
            new ViewInfoStore.ProcessCallback() {
                @Override
                public void processDisappeared(androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder, @NonNull ItemHolderInfo info,
                ...
                @Override
                public void processAppeared(androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder,
                                            ItemHolderInfo preInfo, ItemHolderInfo info) {
                    animateAppearance(viewHolder, preInfo, info);
                }

                @Override
                public void processPersistent(androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder,
        ...
        if (className != null) {
            ...
            if (!className.isEmpty()) {
                ...
                try {
                    ...
                    Class<? extends androidx.recyclerview.widget.RecyclerView.LayoutManager> layoutManagerClass =
                            Class.forName(className, false, classLoader)
                                    .asSubclass(androidx.recyclerview.widget.RecyclerView.LayoutManager.class);
                    Constructor<? extends androidx.recyclerview.widget.RecyclerView.LayoutManager> constructor;
    ...
    private String getFullClassName(Context context, String className) {
        ...
        return androidx.recyclerview.widget.RecyclerView.class.getPackage().getName() + '.' + className;
    }
    ...
    private void initChildrenHelper() {
        mChildHelper = new ChildHelper(new ChildHelper.Callback() {
            ...
            public void addView(View child, int index) {
                ...
                androidx.recyclerview.widget.RecyclerView.this.addView(child, index);
                if (VERBOSE_TRACING) {
            ...
            public void removeViewAt(int index) {
                final View child = androidx.recyclerview.widget.RecyclerView.this.getChildAt(index);
                if (child != null) {
                ...
                androidx.recyclerview.widget.RecyclerView.this.removeViewAt(index);
                if (VERBOSE_TRACING) {
                    TraceCompat.endSection();
                }
            }
            ...
            public View getChildAt(int offset) {
                return androidx.recyclerview.widget.RecyclerView.this.getChildAt(offset);
            }
            ...
            @Override
            public androidx.recyclerview.widget.RecyclerView.ViewHolder getChildViewHolder(View view) {
            ...
            public void attachViewToParent(View child, int index,
                ...
                final androidx.recyclerview.widget.RecyclerView.ViewHolder vh = getChildViewHolderInt(child);
                if (vh != null) {
                ...
                androidx.recyclerview.widget.RecyclerView.this.attachViewToParent(child, index, layoutParams);
            }
            ...
            public void detachViewFromParent(int offset) {
                ...
                if (view != null) {
                    final androidx.recyclerview.widget.RecyclerView.ViewHolder vh = getChildViewHolderInt(view);
                    if (vh != null) {
                        if (vh.isTmpDetached() && !vh.shouldIgnore()) {
                        ...
                        vh.addFlags(androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_TMP_DETACHED);
                    }
                }
                androidx.recyclerview.widget.RecyclerView.this.detachViewFromParent(offset);
            }
            ...
            public void onEnteredHiddenState(View child) {
                final androidx.recyclerview.widget.RecyclerView.ViewHolder vh = getChildViewHolderInt(child);
                if (vh != null) {
                    vh.onEnteredHiddenState(androidx.recyclerview.widget.RecyclerView.this);
                }
            }
            ...
            public void onLeftHiddenState(View child) {
                final androidx.recyclerview.widget.RecyclerView.ViewHolder vh = getChildViewHolderInt(child);
                if (vh != null) {
                    vh.onLeftHiddenState(androidx.recyclerview.widget.RecyclerView.this);
                }
            }
        });
    }
    ...
    void initAdapterManager() {
        mAdapterHelper = new AdapterHelper(new AdapterHelper.Callback() {
            @Override
            public androidx.recyclerview.widget.RecyclerView.ViewHolder findViewHolder(int position) {
                final androidx.recyclerview.widget.RecyclerView.ViewHolder vh = findViewHolderForPosition(position, true);
                if (vh == null) {
                    return null;
                }
            ...
            void dispatchUpdate(AdapterHelper.UpdateOp op) {
                switch (op.cmd) {
                    case AdapterHelper.UpdateOp.ADD:
                        mLayout.onItemsAdded(androidx.recyclerview.widget.RecyclerView.this, op.positionStart, op.itemCount);
                        break;
                    case AdapterHelper.UpdateOp.REMOVE:
                        mLayout.onItemsRemoved(androidx.recyclerview.widget.RecyclerView.this, op.positionStart, op.itemCount);
                        break;
                    case AdapterHelper.UpdateOp.UPDATE:
                        mLayout.onItemsUpdated(androidx.recyclerview.widget.RecyclerView.this, op.positionStart, op.itemCount,
                                op.payload);
                        break;
                    case AdapterHelper.UpdateOp.MOVE:
                        mLayout.onItemsMoved(androidx.recyclerview.widget.RecyclerView.this, op.positionStart, op.itemCount, 1);
                        break;
                }
            }
     ...
     * {@link #setAdapter(androidx.recyclerview.widget.RecyclerView.Adapter)} but assumes existing adapter and the new adapter uses the same
     * {@link androidx.recyclerview.widget.RecyclerView.ViewHolder} and does not clear the RecycledViewPool.
     * <p>
     ...
     *                                      this to false.
     * @see #setAdapter(androidx.recyclerview.widget.RecyclerView.Adapter)
     */
    public void swapAdapter(@Nullable androidx.recyclerview.widget.RecyclerView.Adapter adapter, boolean removeAndRecycleExistingViews) {
     ...
     *
     * @param adapter The new adapter to set, or null to set no adapter.
     * @see #swapAdapter(androidx.recyclerview.widget.RecyclerView.Adapter, boolean)
     */
     ...
     */
    private void setAdapterInternal(@Nullable androidx.recyclerview.widget.RecyclerView.Adapter adapter, boolean compatibleWithPrevious,
        ...
        final androidx.recyclerview.widget.RecyclerView.Adapter oldAdapter = mAdapter;
        mAdapter = adapter;
        if (adapter != null) {
     ...
     * @deprecated Use {@link #addRecyclerListener(androidx.recyclerview.widget.RecyclerView.RecyclerListener)} and
     *     {@link #removeRecyclerListener(androidx.recyclerview.widget.RecyclerView.RecyclerListener)}
     */
    @Deprecated
    public void setRecyclerListener(@Nullable androidx.recyclerview.widget.RecyclerView.RecyclerListener listener) {
     ...
     */
    public void addRecyclerListener(@NonNull androidx.recyclerview.widget.RecyclerView.RecyclerListener listener) {
     ...
     */
    public void removeRecyclerListener(@NonNull androidx.recyclerview.widget.RecyclerView.RecyclerListener listener) {
    ...
    public void addOnChildAttachStateChangeListener(
            @NonNull androidx.recyclerview.widget.RecyclerView.OnChildAttachStateChangeListener listener) {
     ...
     * {@link #addOnChildAttachStateChangeListener(androidx.recyclerview.widget.RecyclerView.OnChildAttachStateChangeListener)}.
     */
    ...
    /**
     * Set the {@link androidx.recyclerview.widget.RecyclerView.LayoutManager} that this RecyclerView will use.
     *
     * <p>In contrast to other adapter-backed views such as {@link android.widget.ListView}
     * or {@link android.widget.GridView}, RecyclerView allows client code to provide custom
     * layout arrangements for child views. These arrangements are controlled by the
     * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager}. A LayoutManager must be provided for RecyclerView to function.</p>
     *
     * <p>Several default strategies are provided for common uses such as lists and grids.</p>
     *
     * @param layout LayoutManager to use
     */
    public void setLayoutManager(@Nullable androidx.recyclerview.widget.RecyclerView.LayoutManager layout) {
        if (layout == mLayout) {
            return;
        }
        stopScroll();
    ...
    /**
     * Set a {@link androidx.recyclerview.widget.RecyclerView.OnFlingListener} for this {@link androidx.recyclerview.widget.RecyclerView}.
     * <p>
     * If the {@link androidx.recyclerview.widget.RecyclerView.OnFlingListener} is set then it will receive
     * calls to {@link #fling(int, int)} and will be able to intercept them.
     *
     * @param onFlingListener The {@link androidx.recyclerview.widget.RecyclerView.OnFlingListener} instance.
     */
    public void setOnFlingListener(@Nullable androidx.recyclerview.widget.RecyclerView.OnFlingListener onFlingListener) {
        mOnFlingListener = onFlingListener;
    }

    /**
     * Get the current {@link androidx.recyclerview.widget.RecyclerView.OnFlingListener} from this {@link androidx.recyclerview.widget.RecyclerView}.
     *
     * @return The {@link androidx.recyclerview.widget.RecyclerView.OnFlingListener} instance currently set (can be null).
     */
    @Nullable
    ...
    protected Parcelable onSaveInstanceState() {
        androidx.recyclerview.widget.RecyclerView.SavedState state = new androidx.recyclerview.widget.RecyclerView.SavedState(super.onSaveInstanceState());
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (!(state instanceof androidx.recyclerview.widget.RecyclerView.SavedState)) {
            super.onRestoreInstanceState(state);
            return;
        }

        mPendingSavedState = (androidx.recyclerview.widget.RecyclerView.SavedState) state;
     ...
     * @see #addAnimatingView(androidx.recyclerview.widget.RecyclerView.ViewHolder)
     */
    boolean removeAnimatingView(View view) {
        startInterceptRequestLayout();
        final boolean removed = mChildHelper.removeViewIfHidden(view);
        if (removed) {
            final androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder = getChildViewHolderInt(view);
            mRecycler.unscrapView(viewHolder);
    ...
    /**
     * Return the {@link androidx.recyclerview.widget.RecyclerView.LayoutManager} currently responsible for
    ...
    /**
     * Retrieve this RecyclerView's {@link androidx.recyclerview.widget.RecyclerView.RecycledViewPool}. This method will never return null;
     * if no pool is set for this view a new one will be created. See
     * {@link #setRecycledViewPool(androidx.recyclerview.widget.RecyclerView.RecycledViewPool) setRecycledViewPool} for more information.
     *
     * @return The pool used to store recycled item views for reuse.
     * @see #setRecycledViewPool(androidx.recyclerview.widget.RecyclerView.RecycledViewPool)
     */
    @NonNull
     ...
     */
    public void setRecycledViewPool(@Nullable androidx.recyclerview.widget.RecyclerView.RecycledViewPool pool) {
        mRecycler.setRecycledViewPool(pool);
    }

    /**
     * Sets a new {@link androidx.recyclerview.widget.RecyclerView.ViewCacheExtension} to be used by the Recycler.
     *
     * @param extension ViewCacheExtension to be used or null if you want to clear the existing one.
     * @see androidx.recyclerview.widget.RecyclerView.ViewCacheExtension#getViewForPositionAndType(androidx.recyclerview.widget.RecyclerView.Recycler, int, int)
     */
    public void setViewCacheExtension(@Nullable androidx.recyclerview.widget.RecyclerView.ViewCacheExtension extension) {
    ...
    /**
     * Add an {@link androidx.recyclerview.widget.RecyclerView.ItemDecoration} to this RecyclerView. Item decorations can
     ...
     * @param decor Decoration to add
     */
    public void addItemDecoration(@NonNull androidx.recyclerview.widget.RecyclerView.ItemDecoration decor) {
        addItemDecoration(decor, -1);
    }

    /**
     * Returns an {@link androidx.recyclerview.widget.RecyclerView.ItemDecoration} previously added to this RecyclerView.
     *
    ...
    /**
     * Returns the number of {@link androidx.recyclerview.widget.RecyclerView.ItemDecoration} currently added to this RecyclerView.
     *
    ...
    /**
     * Removes the {@link androidx.recyclerview.widget.RecyclerView.ItemDecoration} associated with the supplied index position.
     *
    ...
    /**
     * Remove an {@link androidx.recyclerview.widget.RecyclerView.ItemDecoration} from this RecyclerView.
     *
     * <p>The given decoration will no longer impact the measurement and drawing of
     * item views.</p>
     *
     * @param decor Decoration to remove
     * @see #addItemDecoration(androidx.recyclerview.widget.RecyclerView.ItemDecoration)
     */
    ...
    /**
     * Sets the {@link androidx.recyclerview.widget.RecyclerView.ChildDrawingOrderCallback} to be used for drawing children.
     * <p>
    ...
    public void setChildDrawingOrderCallback(
            @Nullable androidx.recyclerview.widget.RecyclerView.ChildDrawingOrderCallback childDrawingOrderCallback) {
     ...
     * @deprecated Use {@link #addOnScrollListener(androidx.recyclerview.widget.RecyclerView.OnScrollListener)} and
     * {@link #removeOnScrollListener(androidx.recyclerview.widget.RecyclerView.OnScrollListener)}
     */
    @Deprecated
    public void setOnScrollListener(@Nullable androidx.recyclerview.widget.RecyclerView.OnScrollListener listener) {
     ...
     */
    public void addOnScrollListener(@NonNull androidx.recyclerview.widget.RecyclerView.OnScrollListener listener) {
     ...
     * @param listener listener to set or null to clear
     */
    public void removeOnScrollListener(@NonNull androidx.recyclerview.widget.RecyclerView.OnScrollListener listener) {
        if (mScrollListeners != null) {
     ...
     * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#smoothScrollToPosition(androidx.recyclerview.widget.RecyclerView, androidx.recyclerview.widget.RecyclerView.State, int)} and create a
     * {@link androidx.recyclerview.widget.RecyclerView.SmoothScroller}.
     * <p>
     * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager} is responsible for creating the actual scroll action. If you want to
     * provide a custom smooth scroll logic, override
     * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#smoothScrollToPosition(androidx.recyclerview.widget.RecyclerView, androidx.recyclerview.widget.RecyclerView.State, int)} in your
     * LayoutManager.
     *
     * @param position The adapter position to scroll to
     * @see androidx.recyclerview.widget.RecyclerView.LayoutManager#smoothScrollToPosition(androidx.recyclerview.widget.RecyclerView, androidx.recyclerview.widget.RecyclerView.State, int)
     */
    ...
    /**
     * Same as {@link androidx.recyclerview.widget.RecyclerView#scrollBy(int, int)}, but also participates in nested scrolling.
    ...
    /**
     * Similar to {@link androidx.recyclerview.widget.RecyclerView#scrollByInternal(int, int, MotionEvent, int)}, but fully
     ...
     * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#scrollHorizontallyBy(int, androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)} and
     * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#scrollVerticallyBy(int, androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)}.
     *
    ...
    private boolean hasUpdatedView() {
        ...
        for (int i = 0; i < childCount; i++) {
            final androidx.recyclerview.widget.RecyclerView.ViewHolder holder = getChildViewHolderInt(mChildHelper.getChildAt(i));
     ...
     * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#computeHorizontalScrollOffset(androidx.recyclerview.widget.RecyclerView.State)} in your
     * LayoutManager. </p>
     *
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#computeHorizontalScrollExtent(androidx.recyclerview.widget.RecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The horizontal extent of the scrollbar's thumb
     * @see androidx.recyclerview.widget.RecyclerView.LayoutManager#computeHorizontalScrollExtent(androidx.recyclerview.widget.RecyclerView.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#computeHorizontalScrollRange(androidx.recyclerview.widget.RecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The total horizontal range represented by the vertical scrollbar
     * @see androidx.recyclerview.widget.RecyclerView.LayoutManager#computeHorizontalScrollRange(androidx.recyclerview.widget.RecyclerView.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#computeVerticalScrollOffset(androidx.recyclerview.widget.RecyclerView.State)} in your
     * LayoutManager.</p>
     *
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#computeVerticalScrollExtent(androidx.recyclerview.widget.RecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The vertical extent of the scrollbar's thumb
     * @see androidx.recyclerview.widget.RecyclerView.LayoutManager#computeVerticalScrollExtent(androidx.recyclerview.widget.RecyclerView.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#computeVerticalScrollRange(androidx.recyclerview.widget.RecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The total vertical range represented by the vertical scrollbar
     * @see androidx.recyclerview.widget.RecyclerView.LayoutManager#computeVerticalScrollRange(androidx.recyclerview.widget.RecyclerView.State)
     */
    @Override
     ...
     * {@link androidx.recyclerview.widget.RecyclerView#requestLayout()}.  Doing so enables {@link androidx.recyclerview.widget.RecyclerView} to avoid
     ...
     * child View to cause a call to {@link androidx.recyclerview.widget.RecyclerView#requestLayout()}.
     *
     ...
     * {@link androidx.recyclerview.widget.RecyclerView#requestLayout()}.
     * <p>
     * A call to this method must always be accompanied by a call to
     * {@link #startInterceptRequestLayout()} that precedes the code that may trigger a child
     * View to cause a call to {@link androidx.recyclerview.widget.RecyclerView#requestLayout()}.
     *
     ...
     * dropped; {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#onFocusSearchFailed(View, int, androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)} will not be
     * called.
     *
     * <p>
     * <code>suppressLayout(true)</code> does not prevent app from directly calling {@link
     * androidx.recyclerview.widget.RecyclerView.LayoutManager#scrollToPosition(int)}, {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#smoothScrollToPosition(
     *androidx.recyclerview.widget.RecyclerView, androidx.recyclerview.widget.RecyclerView.State, int)}.
     * <p>
     * {@link #setAdapter(androidx.recyclerview.widget.RecyclerView.Adapter)} and {@link #swapAdapter(androidx.recyclerview.widget.RecyclerView.Adapter, boolean)} will automatically
     * stop suppressing.
     * <p>
    ...
    /**
     * @deprecated Use {@link #setItemAnimator(androidx.recyclerview.widget.RecyclerView.ItemAnimator)} ()}.
     */
    @Deprecated
    @Override
     ...
     *   {@link androidx.recyclerview.widget.RecyclerView.LayoutManager} must support scrolling in a direction for which the value is not 0.
     ...
     * @see androidx.recyclerview.widget.RecyclerView.LayoutManager#canScrollVertically()
     * @see androidx.recyclerview.widget.RecyclerView.LayoutManager#canScrollHorizontally()
     */
    ...
    void ensureLeftGlow() {
        ...
        mLeftGlow = mEdgeEffectFactory.createEdgeEffect(this, androidx.recyclerview.widget.RecyclerView.EdgeEffectFactory.DIRECTION_LEFT);
        if (mClipToPadding) {
    ...
    void ensureRightGlow() {
        ...
        mRightGlow = mEdgeEffectFactory.createEdgeEffect(this, androidx.recyclerview.widget.RecyclerView.EdgeEffectFactory.DIRECTION_RIGHT);
        if (mClipToPadding) {
    ...
    void ensureTopGlow() {
        ...
        mTopGlow = mEdgeEffectFactory.createEdgeEffect(this, androidx.recyclerview.widget.RecyclerView.EdgeEffectFactory.DIRECTION_TOP);
        if (mClipToPadding) {
    ...
    void ensureBottomGlow() {
        ...
        mBottomGlow = mEdgeEffectFactory.createEdgeEffect(this, androidx.recyclerview.widget.RecyclerView.EdgeEffectFactory.DIRECTION_BOTTOM);
        if (mClipToPadding) {
    ...
    /**
     * Set a {@link androidx.recyclerview.widget.RecyclerView.EdgeEffectFactory} for this {@link androidx.recyclerview.widget.RecyclerView}.
     * <p>
     * When a new {@link androidx.recyclerview.widget.RecyclerView.EdgeEffectFactory} is set, any existing over-scroll effects are cleared
     * and new effects are created as needed using
     * {@link androidx.recyclerview.widget.RecyclerView.EdgeEffectFactory#createEdgeEffect(androidx.recyclerview.widget.RecyclerView, int)}
     *
     * @param edgeEffectFactory The {@link androidx.recyclerview.widget.RecyclerView.EdgeEffectFactory} instance.
     */
    public void setEdgeEffectFactory(@NonNull androidx.recyclerview.widget.RecyclerView.EdgeEffectFactory edgeEffectFactory) {
    ...
    /**
     * Retrieves the previously set {@link androidx.recyclerview.widget.RecyclerView.EdgeEffectFactory} or the default factory if nothing
     * was set.
     *
     * @return The previously set {@link androidx.recyclerview.widget.RecyclerView.EdgeEffectFactory}
     * @see #setEdgeEffectFactory(androidx.recyclerview.widget.RecyclerView.EdgeEffectFactory)
     */
    @NonNull
     ...
     * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#onFocusSearchFailed(View, int, androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)} to layout more Views
     ...
     * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#onFocusSearchFailed(View, int, androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)} before running a
    ...
    private void requestChildOnScreen(@NonNull View child, @Nullable View focused) {
        ...
        if (focusedLayoutParams instanceof androidx.recyclerview.widget.RecyclerView.LayoutParams) {
            // if focused child has item decors, use them. Otherwise, ignore.
            final androidx.recyclerview.widget.RecyclerView.LayoutParams lp = (androidx.recyclerview.widget.RecyclerView.LayoutParams) focusedLayoutParams;
            if (!lp.mInsetsDirty) {
    ...
    /**
     * Add an {@link androidx.recyclerview.widget.RecyclerView.OnItemTouchListener} to intercept touch events before they are dispatched
     * to child views or this view's standard scrolling behavior.
     *
     * <p>Client code may use listeners to implement item manipulation behavior. Once a listener
     * returns true from
     * {@link androidx.recyclerview.widget.RecyclerView.OnItemTouchListener#onInterceptTouchEvent(androidx.recyclerview.widget.RecyclerView, MotionEvent)} its
     * {@link androidx.recyclerview.widget.RecyclerView.OnItemTouchListener#onTouchEvent(androidx.recyclerview.widget.RecyclerView, MotionEvent)} method will be called
     * for each incoming MotionEvent until the end of the gesture.</p>
     *
     * @param listener Listener to add
     * @see androidx.recyclerview.widget.RecyclerView.SimpleOnItemTouchListener
     */
    public void addOnItemTouchListener(@NonNull androidx.recyclerview.widget.RecyclerView.OnItemTouchListener listener) {
        mOnItemTouchListeners.add(listener);
    }

    /**
     * Remove an {@link androidx.recyclerview.widget.RecyclerView.OnItemTouchListener}. It will no longer be able to intercept touch events.
     *
     * @param listener Listener to remove
     */
    public void removeOnItemTouchListener(@NonNull androidx.recyclerview.widget.RecyclerView.OnItemTouchListener listener) {
     ...
     *
     * <p>Calls {@link androidx.recyclerview.widget.RecyclerView.OnItemTouchListener#onInterceptTouchEvent(androidx.recyclerview.widget.RecyclerView, MotionEvent)} on each
     * of the registered {@link androidx.recyclerview.widget.RecyclerView.OnItemTouchListener}s, passing in the
     * MotionEvent. If one returns true and the action is not ACTION_CANCEL, saves the intercepting
     * OnItemTouchListener to be called for future {@link androidx.recyclerview.widget.RecyclerView#onTouchEvent(MotionEvent)}
    ...
    private boolean findInterceptingOnItemTouchListener(MotionEvent e) {
        ...
        for (int i = 0; i < listenerCount; i++) {
            final androidx.recyclerview.widget.RecyclerView.OnItemTouchListener listener = mOnItemTouchListeners.get(i);
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        if (mLayout.isAutoMeasureEnabled()) {
             ...
             * override {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#onMeasure(int, int)} when
             * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#isAutoMeasureEnabled()} returns true.
             */
            ...
            if (mState.mLayoutStep == androidx.recyclerview.widget.RecyclerView.State.STEP_START) {
                dispatchLayoutStep1();
            }
    ...
    void defaultOnMeasure(int widthSpec, int heightSpec) {
        ...
        final int width = androidx.recyclerview.widget.RecyclerView.LayoutManager.chooseSize(widthSpec,
                getPaddingLeft() + getPaddingRight(),
                ViewCompat.getMinimumWidth(this));
        final int height = androidx.recyclerview.widget.RecyclerView.LayoutManager.chooseSize(heightSpec,
    ...
    /**
     * Sets the {@link androidx.recyclerview.widget.RecyclerView.ItemAnimator} that will handle animations involving changes
     * to the items in this RecyclerView. By default, RecyclerView instantiates and
     * uses an instance of {@link DefaultItemAnimator}. Whether item animations are
     * enabled for the RecyclerView depends on the ItemAnimator and whether
     * the LayoutManager {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#supportsPredictiveItemAnimations()
     * supports item animations}.
     *
     * @param animator The ItemAnimator being set. If null, no animations will occur
     *                 when changes occur to the items in this RecyclerView.
     */
    public void setItemAnimator(@Nullable androidx.recyclerview.widget.RecyclerView.ItemAnimator animator) {
        if (mItemAnimator != null) {
            mItemAnimator.endAnimations();
     ...
     * {@link androidx.recyclerview.widget.RecyclerView.ItemAnimator#animatePersistence(androidx.recyclerview.widget.RecyclerView.ViewHolder, ItemHolderInfo, ItemHolderInfo)}
     * DISAPPEARING views are animated via
     * {@link androidx.recyclerview.widget.RecyclerView.ItemAnimator#animateDisappearance(androidx.recyclerview.widget.RecyclerView.ViewHolder, ItemHolderInfo, ItemHolderInfo)}
     * APPEARING views are animated via
     * {@link androidx.recyclerview.widget.RecyclerView.ItemAnimator#animateAppearance(androidx.recyclerview.widget.RecyclerView.ViewHolder, ItemHolderInfo, ItemHolderInfo)}
     * and changed views are animated via
     * {@link androidx.recyclerview.widget.RecyclerView.ItemAnimator#animateChange(androidx.recyclerview.widget.RecyclerView.ViewHolder, androidx.recyclerview.widget.RecyclerView.ViewHolder, ItemHolderInfo, ItemHolderInfo)}.
     */
    void dispatchLayout() {
        if (mAdapter == null) {
    ...
    private void saveFocusInfo() {
        ...
        final androidx.recyclerview.widget.RecyclerView.ViewHolder focusedVh = child == null ? null : findContainingViewHolder(child);
        if (focusedVh == null) {
            resetFocusInfo();
        } else {
    ...
    private View findNextViewToFocus() {
        int startFocusSearchIndex = mState.mFocusedItemPosition != -1 ? mState.mFocusedItemPosition
                : 0;
        androidx.recyclerview.widget.RecyclerView.ViewHolder nextFocus;
    ...
    private void recoverFocusFromState() {
        ...
        androidx.recyclerview.widget.RecyclerView.ViewHolder focusTarget = null;
    ...
    private void dispatchLayoutStep1() {
        mState.assertLayoutStep(androidx.recyclerview.widget.RecyclerView.State.STEP_START);
        fillRemainingScrollValues(mState);
        mState.mIsMeasuring = false;
        startInterceptRequestLayout();
            ...
            for (int i = 0; i < count; ++i) {
                ...
                final ItemHolderInfo animationInfo = mItemAnimator
                        .recordPreLayoutInformation(mState, holder,
                                androidx.recyclerview.widget.RecyclerView.ItemAnimator.buildAdapterChangeFlagsForAnimations(holder),
        ...
        if (mState.mRunPredictiveAnimations) {
            ...
            for (int i = 0; i < mChildHelper.getChildCount(); ++i) {
                ...
                final androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder = getChildViewHolderInt(child);
                if (viewHolder.shouldIgnore()) {
                    continue;
                }
                if (!mViewInfoStore.isInPreLayout(viewHolder)) {
                    int flags = androidx.recyclerview.widget.RecyclerView.ItemAnimator.buildAdapterChangeFlagsForAnimations(viewHolder);
                    boolean wasHidden = viewHolder
                            .hasAnyOfTheFlags(androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_BOUNCED_FROM_HIDDEN_LIST);
                    if (!wasHidden) {
                        flags |= androidx.recyclerview.widget.RecyclerView.ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT;
                    }
        ...
        onExitLayoutOrScroll();
        stopInterceptRequestLayout(false);
        mState.mLayoutStep = androidx.recyclerview.widget.RecyclerView.State.STEP_LAYOUT;
    }
    ...
    private void dispatchLayoutStep2() {
        startInterceptRequestLayout();
        onEnterLayoutOrScroll();
        mState.assertLayoutStep(androidx.recyclerview.widget.RecyclerView.State.STEP_LAYOUT | androidx.recyclerview.widget.RecyclerView.State.STEP_ANIMATIONS);
        mAdapterHelper.consumeUpdatesInOnePass();
        mState.mItemCount = mAdapter.getItemCount();
        ...
        mState.mLayoutStep = androidx.recyclerview.widget.RecyclerView.State.STEP_ANIMATIONS;
        onExitLayoutOrScroll();
        stopInterceptRequestLayout(false);
    }
    ...
    private void dispatchLayoutStep3() {
        mState.assertLayoutStep(androidx.recyclerview.widget.RecyclerView.State.STEP_ANIMATIONS);
        startInterceptRequestLayout();
        onEnterLayoutOrScroll();
        mState.mLayoutStep = androidx.recyclerview.widget.RecyclerView.State.STEP_START;
        if (mState.mRunSimpleAnimations) {
            // Step 3: Find out where things are now, and process change animations.
            // traverse list in reverse because we may call animateChange in the loop which may
            // remove the target view holder.
            for (int i = mChildHelper.getChildCount() - 1; i >= 0; i--) {
                androidx.recyclerview.widget.RecyclerView.ViewHolder holder = getChildViewHolderInt(mChildHelper.getChildAt(i));
                ...
                androidx.recyclerview.widget.RecyclerView.ViewHolder oldChangeViewHolder = mViewInfoStore.getFromOldChangeHolders(key);
    ...
    private void handleMissingPreInfoForChangeError(long key,
                                                    androidx.recyclerview.widget.RecyclerView.ViewHolder holder, androidx.recyclerview.widget.RecyclerView.ViewHolder oldChangeViewHolder) {
        // check if two VH have the same key, if so, print that as an error
        final int childCount = mChildHelper.getChildCount();
        for (int i = 0; i < childCount; i++) {
            View view = mChildHelper.getChildAt(i);
            androidx.recyclerview.widget.RecyclerView.ViewHolder other = getChildViewHolderInt(view);
            if (other == holder) {
                continue;
            }
     ...
     */
    void recordAnimationInfoIfBouncedHiddenView(androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder,
                                                ItemHolderInfo animationInfo) {
        // looks like this view bounced back from hidden list!
        viewHolder.setFlags(0, androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_BOUNCED_FROM_HIDDEN_LIST);
    ...
    protected void removeDetachedView(View child, boolean animate) {
        androidx.recyclerview.widget.RecyclerView.ViewHolder vh = getChildViewHolderInt(child);
        if (vh != null) {
            if (vh.isTmpDetached()) {
                vh.clearTmpDetachFlag();
     ...
     */
    long getChangedHolderKey(androidx.recyclerview.widget.RecyclerView.ViewHolder holder) {
        return mAdapter.hasStableIds() ? holder.getItemId() : holder.mPosition;
    }

    void animateAppearance(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder itemHolder,
    ...
    void animateDisappearance(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder holder,
    ...
    private void animateChange(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder oldHolder, @NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder newHolder,
                               @NonNull ItemHolderInfo preInfo, @NonNull ItemHolderInfo postInfo,
    ...
    void markItemDecorInsetsDirty() {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            ((androidx.recyclerview.widget.RecyclerView.LayoutParams) child.getLayoutParams()).mInsetsDirty = true;
        }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof androidx.recyclerview.widget.RecyclerView.LayoutParams && mLayout.checkLayoutParams((androidx.recyclerview.widget.RecyclerView.LayoutParams) p);
    }
     ...
     * {@link androidx.recyclerview.widget.RecyclerView.ItemAnimator#isRunning(androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemAnimatorFinishedListener)}.
     *
    ...
    void saveOldPositions() {
        final int childCount = mChildHelper.getUnfilteredChildCount();
        for (int i = 0; i < childCount; i++) {
            final androidx.recyclerview.widget.RecyclerView.ViewHolder holder = getChildViewHolderInt(mChildHelper.getUnfilteredChildAt(i));
    ...
    void viewRangeUpdate(int positionStart, int itemCount, Object payload) {
        ...
        for (int i = 0; i < childCount; i++) {
            final View child = mChildHelper.getUnfilteredChildAt(i);
            final androidx.recyclerview.widget.RecyclerView.ViewHolder holder = getChildViewHolderInt(child);
            if (holder == null || holder.shouldIgnore()) {
                continue;
            }
            if (holder.mPosition >= positionStart && holder.mPosition < positionEnd) {
                ...
                holder.addFlags(androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_UPDATE);
     ...
     *                             {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#onItemsChanged(androidx.recyclerview.widget.RecyclerView)} during
     *                             measure/layout.
     */
    ...
    void markKnownViewsInvalid() {
        ...
        for (int i = 0; i < childCount; i++) {
            final androidx.recyclerview.widget.RecyclerView.ViewHolder holder = getChildViewHolderInt(mChildHelper.getUnfilteredChildAt(i));
            if (holder != null && !holder.shouldIgnore()) {
                holder.addFlags(androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_UPDATE | androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_INVALID);
            }
        }
        markItemDecorInsetsDirty();
    ...
    /**
     * Retrieve the {@link androidx.recyclerview.widget.RecyclerView.ViewHolder} for the given child view.
     *
     * @param child Child of this RecyclerView to query for its ViewHolder
     * @return The child view's ViewHolder
     */
    public androidx.recyclerview.widget.RecyclerView.ViewHolder getChildViewHolder(@NonNull View child) {
     ...
     */
    @Nullable
    public androidx.recyclerview.widget.RecyclerView.ViewHolder findContainingViewHolder(@NonNull View view) {
        View itemView = findContainingItemView(view);
        return itemView == null ? null : getChildViewHolder(itemView);
    }


    static androidx.recyclerview.widget.RecyclerView.ViewHolder getChildViewHolderInt(View child) {
        if (child == null) {
            return null;
        }
        return ((androidx.recyclerview.widget.RecyclerView.LayoutParams) child.getLayoutParams()).mViewHolder;
    }
    ...
    @Deprecated
    @Nullable
    public androidx.recyclerview.widget.RecyclerView.ViewHolder findViewHolderForPosition(int position) {
     ...
     * #{@link androidx.recyclerview.widget.RecyclerView.ViewHolder#getBindingAdapterPosition()} to get the current adapter position
     * of a ViewHolder. If the {@link androidx.recyclerview.widget.RecyclerView.Adapter} that is assigned to the RecyclerView is an adapter
     * that combines other adapters (e.g. {@link ConcatAdapter}), you can use the
     * {@link androidx.recyclerview.widget.RecyclerView.ViewHolder#getBindingAdapter()}) to find the position relative to the {@link androidx.recyclerview.widget.RecyclerView.Adapter}
     * that bound the {@link androidx.recyclerview.widget.RecyclerView.ViewHolder}.
     * <p>
     ...
     */
    @Nullable
    public androidx.recyclerview.widget.RecyclerView.ViewHolder findViewHolderForLayoutPosition(int position) {
        return findViewHolderForPosition(position, false);
    }
     ...
     * {@link androidx.recyclerview.widget.RecyclerView.Adapter#notifyDataSetChanged()} has been called but the new layout has not been
     ...
     */
    @Nullable
    public androidx.recyclerview.widget.RecyclerView.ViewHolder findViewHolderForAdapterPosition(int position) {
        if (mDataSetHasChangedAfterLayout) {
            return null;
        }
        final int childCount = mChildHelper.getUnfilteredChildCount();
        // hidden VHs are not preferred but if that is the only one we find, we rather return it
        androidx.recyclerview.widget.RecyclerView.ViewHolder hidden = null;
        for (int i = 0; i < childCount; i++) {
            final androidx.recyclerview.widget.RecyclerView.ViewHolder holder = getChildViewHolderInt(mChildHelper.getUnfilteredChildAt(i));
    ...
    @Nullable
    androidx.recyclerview.widget.RecyclerView.ViewHolder findViewHolderForPosition(int position, boolean checkNewPosition) {
        final int childCount = mChildHelper.getUnfilteredChildCount();
        androidx.recyclerview.widget.RecyclerView.ViewHolder hidden = null;
        for (int i = 0; i < childCount; i++) {
            final androidx.recyclerview.widget.RecyclerView.ViewHolder holder = getChildViewHolderInt(mChildHelper.getUnfilteredChildAt(i));
     ...
     * use an Adapter with {@link androidx.recyclerview.widget.RecyclerView.Adapter#setHasStableIds(boolean) stableIds} to
     ...
     */
    public androidx.recyclerview.widget.RecyclerView.ViewHolder findViewHolderForItemId(long id) {
        if (mAdapter == null || !mAdapter.hasStableIds()) {
            return null;
        }
        final int childCount = mChildHelper.getUnfilteredChildCount();
     ...
     * Useful for implementing simple scrolling in {@link androidx.recyclerview.widget.RecyclerView.LayoutManager LayoutManagers}.
     *
     ...
     * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager} measures or lays out the view and is a good time to perform these
     * changes.</p>
     *
     ...
     * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager} fully detaches the child view from the parent and its window.</p>
     *
    ...
    static void getDecoratedBoundsWithMarginsInt(View view, Rect outBounds) {
        final androidx.recyclerview.widget.RecyclerView.LayoutParams lp = (androidx.recyclerview.widget.RecyclerView.LayoutParams) view.getLayoutParams();
        final Rect insets = lp.mDecorInsets;
    ...
    Rect getItemDecorInsetsForChild(View child) {
        final androidx.recyclerview.widget.RecyclerView.LayoutParams lp = (androidx.recyclerview.widget.RecyclerView.LayoutParams) child.getLayoutParams();
        if (!lp.mInsetsDirty) {
    ...
    class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                if (mAdapter != null) {
                    ...
                    androidx.recyclerview.widget.RecyclerView.SmoothScroller smoothScroller = mLayout.mSmoothScroller;
                ...
                if (!smoothScrollerPending && doneScrolling) {
                    ...
                    postOnAnimation();
                    if (mGapWorker != null) {
                        mGapWorker.postFromTraversal(androidx.recyclerview.widget.RecyclerView.this, consumedX, consumedY);
                    }
                }
            }
        ...
        private void internalPostOnAnimation() {
            ...
            ViewCompat.postOnAnimation(androidx.recyclerview.widget.RecyclerView.this, this);
        }
    ...
    void repositionShadowingViews() {
        ...
        for (int i = 0; i < count; i++) {
            View view = mChildHelper.getChildAt(i);
            androidx.recyclerview.widget.RecyclerView.ViewHolder holder = getChildViewHolder(view);
    ...
    private class RecyclerViewDataObserver extends androidx.recyclerview.widget.RecyclerView.AdapterDataObserver {
        ...
        void triggerUpdateProcessor() {
            if (POST_UPDATES_ON_ANIMATION && mHasFixedSize && mIsAttached) {
                ViewCompat.postOnAnimation(androidx.recyclerview.widget.RecyclerView.this, mUpdateChildViewsRunnable);
            } else {
        ...
        public void onStateRestorationPolicyChanged() {
            ...
            androidx.recyclerview.widget.RecyclerView.Adapter<?> adapter = mAdapter;
     ...
     *
     * @see androidx.recyclerview.widget.RecyclerView#setEdgeEffectFactory(androidx.recyclerview.widget.RecyclerView.EdgeEffectFactory)
     */
    public static class EdgeEffectFactory {
         ...
         */
        protected @NonNull
        EdgeEffect createEdgeEffect(@NonNull androidx.recyclerview.widget.RecyclerView view,
                                    @androidx.recyclerview.widget.RecyclerView.EdgeEffectFactory.EdgeDirection int direction) {
     ...
     * and use {@link androidx.recyclerview.widget.RecyclerView#setRecycledViewPool(androidx.recyclerview.widget.RecyclerView.RecycledViewPool)}.
     * <p>
    ...
    public static class RecycledViewPool {
        ...
        static class ScrapData {
            final ArrayList<androidx.recyclerview.widget.RecyclerView.ViewHolder> mScrapHeap = new ArrayList<>();
            int mMaxScrap = DEFAULT_MAX_SCRAP;
            long mCreateRunningAverageNs = 0;
            long mBindRunningAverageNs = 0;
        }

        SparseArray<androidx.recyclerview.widget.RecyclerView.RecycledViewPool.ScrapData> mScrap = new SparseArray<>();
        ...
        public void clear() {
            for (int i = 0; i < mScrap.size(); i++) {
                androidx.recyclerview.widget.RecyclerView.RecycledViewPool.ScrapData data = mScrap.valueAt(i);
        ...
        public void setMaxRecycledViews(int viewType, int max) {
            androidx.recyclerview.widget.RecyclerView.RecycledViewPool.ScrapData scrapData = getScrapDataForType(viewType);
            scrapData.mMaxScrap = max;
            final ArrayList<androidx.recyclerview.widget.RecyclerView.ViewHolder> scrapHeap = scrapData.mScrapHeap;
        ...
        public androidx.recyclerview.widget.RecyclerView.ViewHolder getRecycledView(int viewType) {
            final androidx.recyclerview.widget.RecyclerView.RecycledViewPool.ScrapData scrapData = mScrap.get(viewType);
        ...
        int size() {
            int count = 0;
            for (int i = 0; i < mScrap.size(); i++) {
                ArrayList<androidx.recyclerview.widget.RecyclerView.ViewHolder> viewHolders = mScrap.valueAt(i).mScrapHeap;
                if (viewHolders != null) {
         ...
         */
        public void putRecycledView(androidx.recyclerview.widget.RecyclerView.ViewHolder scrap) {
            final int viewType = scrap.getItemViewType();
            final ArrayList<androidx.recyclerview.widget.RecyclerView.ViewHolder> scrapHeap = getScrapDataForType(viewType).mScrapHeap;
         ...
         */
        void onAdapterChanged(androidx.recyclerview.widget.RecyclerView.Adapter oldAdapter, androidx.recyclerview.widget.RecyclerView.Adapter newAdapter,
        ...
        private androidx.recyclerview.widget.RecyclerView.RecycledViewPool.ScrapData getScrapDataForType(int viewType) {
            androidx.recyclerview.widget.RecyclerView.RecycledViewPool.ScrapData scrapData = mScrap.get(viewType);
            if (scrapData == null) {
                scrapData = new androidx.recyclerview.widget.RecyclerView.RecycledViewPool.ScrapData();
     ...
     */
    @Nullable
    static androidx.recyclerview.widget.RecyclerView findNestedRecyclerView(@NonNull View view) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            final androidx.recyclerview.widget.RecyclerView descendant = findNestedRecyclerView(child);
            if (descendant != null) {
                return descendant;
            }
        }
     ...
     */
    static void clearNestedRecyclerViewIfNotNested(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder holder) {
     ...
     *
     * <p>Typical use of a Recycler by a {@link androidx.recyclerview.widget.RecyclerView.LayoutManager} will be to obtain views for
    ...
    public final class Recycler {
        final ArrayList<androidx.recyclerview.widget.RecyclerView.ViewHolder> mAttachedScrap = new ArrayList<>();
        ArrayList<androidx.recyclerview.widget.RecyclerView.ViewHolder> mChangedScrap = null;

        final ArrayList<androidx.recyclerview.widget.RecyclerView.ViewHolder> mCachedViews = new ArrayList<androidx.recyclerview.widget.RecyclerView.ViewHolder>();

        private final List<androidx.recyclerview.widget.RecyclerView.ViewHolder>
         ...
         */
        @NonNull
        public List<androidx.recyclerview.widget.RecyclerView.ViewHolder> getScrapList() {
         ...
         */
        boolean validateViewHolderForOffsetPosition(androidx.recyclerview.widget.RecyclerView.ViewHolder holder) {
        ...
        private boolean tryBindViewHolderByDeadline(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder holder, int offsetPosition,
                                                    int position, long deadlineNs) {
            holder.mBindingAdapter = null;
            holder.mOwnerRecyclerView = androidx.recyclerview.widget.RecyclerView.this;
         ...
         * {@link androidx.recyclerview.widget.RecyclerView.Adapter#onCreateViewHolder(ViewGroup, int)}.
         * <p>
        ...
        public void bindViewToPosition(@NonNull View view, int position) {
            androidx.recyclerview.widget.RecyclerView.ViewHolder holder = getChildViewHolderInt(view);
            if (holder == null) {
            ...
            final androidx.recyclerview.widget.RecyclerView.LayoutParams rvLayoutParams;
            if (lp == null) {
                rvLayoutParams = (androidx.recyclerview.widget.RecyclerView.LayoutParams) generateDefaultLayoutParams();
                holder.itemView.setLayoutParams(rvLayoutParams);
            } else if (!checkLayoutParams(lp)) {
                rvLayoutParams = (androidx.recyclerview.widget.RecyclerView.LayoutParams) generateLayoutParams(lp);
                holder.itemView.setLayoutParams(rvLayoutParams);
            } else {
                rvLayoutParams = (androidx.recyclerview.widget.RecyclerView.LayoutParams) lp;
            }
         ...
         * automatically maps these positions to {@link androidx.recyclerview.widget.RecyclerView.Adapter} positions when
         ...
         *                 less than {@link androidx.recyclerview.widget.RecyclerView.State#getItemCount()}.
         */
         ...
         *
         * This method should be used by {@link androidx.recyclerview.widget.RecyclerView.LayoutManager} implementations to obtain
         * views to represent data from an {@link androidx.recyclerview.widget.RecyclerView.Adapter}.
         * <p>
         ...
         * returned. Use {@link androidx.recyclerview.widget.RecyclerView.ViewHolder#isBound()} on the returned object to check for this.
         *
         ...
         */
        @Nullable
        androidx.recyclerview.widget.RecyclerView.ViewHolder tryGetViewHolderForPositionByDeadline(int position,
                ...
                if (holder != null) {
                    if (!validateViewHolderForOffsetPosition(holder)) {
                        ...
                        if (!dryRun) {
                            ...
                            // animation logic etc.
                            holder.addFlags(androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_INVALID);
                            if (holder.isScrap()) {
            ...
            if (holder == null) {
                ...
                if (holder == null) {
                    ...
                    holder = mAdapter.createViewHolder(androidx.recyclerview.widget.RecyclerView.this, type);
                    if (ALLOW_THREAD_GAP_WORK) {
                        // only bother finding nested RV if prefetching
                        androidx.recyclerview.widget.RecyclerView innerView = findNestedRecyclerView(holder.itemView);
                        if (innerView != null) {
            ...
            if (fromScrapOrHiddenOrCache && !mState.isPreLayout() && holder
                    .hasAnyOfTheFlags(androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_BOUNCED_FROM_HIDDEN_LIST)) {
                holder.setFlags(0, androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_BOUNCED_FROM_HIDDEN_LIST);
                if (mState.mRunSimpleAnimations) {
                    int changeFlags = androidx.recyclerview.widget.RecyclerView.ItemAnimator
                            .buildAdapterChangeFlagsForAnimations(holder);
                    changeFlags |= androidx.recyclerview.widget.RecyclerView.ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT;
        ...
        private void attachAccessibilityDelegateOnBind(androidx.recyclerview.widget.RecyclerView.ViewHolder holder) {
        ...
        private void invalidateDisplayListInt(androidx.recyclerview.widget.RecyclerView.ViewHolder holder) {
         ...
         * @see androidx.recyclerview.widget.RecyclerView.LayoutManager#removeAndRecycleView(View, androidx.recyclerview.widget.RecyclerView.Recycler)
         */
        ...
        void recycleCachedViewAt(int cachedViewIndex) {
            ...
            androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder = mCachedViews.get(cachedViewIndex);
            if (DEBUG) {
         ...
         */
        void recycleViewHolderInternal(androidx.recyclerview.widget.RecyclerView.ViewHolder holder) {
            ...
            if (forceRecycle || holder.isRecyclable()) {
                if (mViewCacheMax > 0
                        && !holder.hasAnyOfTheFlags(androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_INVALID
                        | androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_REMOVED
                        | androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_UPDATE
                        | androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_ADAPTER_POSITION_UNKNOWN)) {
         ...
         */
        void addViewHolderToRecycledViewPool(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder holder, boolean dispatchRecycled) {
        ...
        void quickRecycleScrapView(View view) {
            final androidx.recyclerview.widget.RecyclerView.ViewHolder holder = getChildViewHolderInt(view);
        ...
        void scrapView(View view) {
            final androidx.recyclerview.widget.RecyclerView.ViewHolder holder = getChildViewHolderInt(view);
            if (holder.hasAnyOfTheFlags(androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_REMOVED | androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_INVALID)
                ...
                if (mChangedScrap == null) {
                    mChangedScrap = new ArrayList<androidx.recyclerview.widget.RecyclerView.ViewHolder>();
                }
         ...
         */
        void unscrapView(androidx.recyclerview.widget.RecyclerView.ViewHolder holder) {
        ...
        androidx.recyclerview.widget.RecyclerView.ViewHolder getChangedScrapViewForPosition(int position) {
            ...
            for (int i = 0; i < changedScrapSize; i++) {
                final androidx.recyclerview.widget.RecyclerView.ViewHolder holder = mChangedScrap.get(i);
                if (!holder.wasReturnedFromScrap() && holder.getLayoutPosition() == position) {
                    holder.addFlags(androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_RETURNED_FROM_SCRAP);
                    return holder;
                }
            }
            // find by id
         ...
         */
        androidx.recyclerview.widget.RecyclerView.ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int position, boolean dryRun) {
            final int scrapCount = mAttachedScrap.size();

            // Try first for an exact, non-invalid match from scrap.
            for (int i = 0; i < scrapCount; i++) {
                final androidx.recyclerview.widget.RecyclerView.ViewHolder holder = mAttachedScrap.get(i);
                if (!holder.wasReturnedFromScrap() && holder.getLayoutPosition() == position
            ...
            if (!dryRun) {
                ...
                if (view != null) {
                    ...
                    if (layoutIndex == androidx.recyclerview.widget.RecyclerView.NO_POSITION) {
                        throw new IllegalStateException("layout index should not be -1 after "
                                + "unhiding a view:" + vh + exceptionLabel());
                    }
                    mChildHelper.detachViewFromParent(layoutIndex);
                    scrapView(view);
                    vh.addFlags(androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_RETURNED_FROM_SCRAP
                            | androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_BOUNCED_FROM_HIDDEN_LIST);
                    return vh;
                }
            }
            ...
            for (int i = 0; i < cacheSize; i++) {
                final androidx.recyclerview.widget.RecyclerView.ViewHolder holder = mCachedViews.get(i);
        ...
        androidx.recyclerview.widget.RecyclerView.ViewHolder getScrapOrCachedViewForId(long id, int type, boolean dryRun) {
                ...
                if (holder.getItemId() == id && !holder.wasReturnedFromScrap()) {
                    if (type == holder.getItemViewType()) {
                        ...
                        if (holder.isRemoved()) {
                            ...
                            // between.
                            if (!mState.isPreLayout()) {
                                holder.setFlags(androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_UPDATE, androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_UPDATE
                                        | androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_INVALID | androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_REMOVED);
                            }
                        }
                        return holder;
                    } else if (!dryRun) {
        ...
        @SuppressWarnings("unchecked")
        void dispatchViewRecycled(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder holder) {
            ...
            for (int i = cachedCount - 1; i >= 0; i--) {
                ...
                if (holder != null) {
                    if (holder.mPosition >= removedEnd) {
                        ...
                        holder.addFlags(androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_REMOVED);
                        recycleCachedViewAt(i);
                    }
                }
            }
        ...
        void setViewCacheExtension(androidx.recyclerview.widget.RecyclerView.ViewCacheExtension extension) {
            mViewCacheExtension = extension;
        }

        void setRecycledViewPool(androidx.recyclerview.widget.RecyclerView.RecycledViewPool pool) {
        ...
        androidx.recyclerview.widget.RecyclerView.RecycledViewPool getRecycledViewPool() {
            if (mRecyclerPool == null) {
                mRecyclerPool = new androidx.recyclerview.widget.RecyclerView.RecycledViewPool();
            }
        ...
        void markItemDecorInsetsDirty() {
            ...
            for (int i = 0; i < cachedCount; i++) {
                final androidx.recyclerview.widget.RecyclerView.ViewHolder holder = mCachedViews.get(i);
                androidx.recyclerview.widget.RecyclerView.LayoutParams layoutParams = (androidx.recyclerview.widget.RecyclerView.LayoutParams) holder.itemView.getLayoutParams();
     ...
     * <p>
     * When {@link androidx.recyclerview.widget.RecyclerView.Recycler#getViewForPosition(int)} is called, Recycler checks attached scrap and
     * first level cache to find a matching View. If it cannot find a suitable View, Recycler will
     * call the {@link #getViewForPositionAndType(androidx.recyclerview.widget.RecyclerView.Recycler, int, int)} before checking
     * {@link androidx.recyclerview.widget.RecyclerView.RecycledViewPool}.
     * <p>
    ...
    public abstract static class ViewCacheExtension {
         ...
         * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#stopIgnoringView(View)} before returning the View.
         * <p>
         ...
         * @see androidx.recyclerview.widget.RecyclerView.LayoutManager#ignoreView(View)
         */
        @Nullable
        public abstract View getViewForPositionAndType(@NonNull androidx.recyclerview.widget.RecyclerView.Recycler recycler, int position,
                                                       int type);
    }
     ...
     * within a {@link androidx.recyclerview.widget.RecyclerView}.</p>
     *
     * @param <VH> A class that extends ViewHolder that will be used by the adapter.
     */
    public abstract static class Adapter<VH extends androidx.recyclerview.widget.RecyclerView.ViewHolder> {
         ...
         * on (e.g. in a click listener), use {@link androidx.recyclerview.widget.RecyclerView.ViewHolder#getBindingAdapterPosition()} which
         ...
         * should update the contents of the {@link androidx.recyclerview.widget.RecyclerView.ViewHolder#itemView} to reflect the item at
         * the given position.
         * <p>
         * Note that unlike {@link android.widget.ListView}, RecyclerView will not call this method
         * again if the position of the item changes in the data set unless the item itself is
        ...
        /**
         * Returns the position of the given {@link androidx.recyclerview.widget.RecyclerView.ViewHolder} in the given {@link androidx.recyclerview.widget.RecyclerView.Adapter}.
         *
         * If the given {@link androidx.recyclerview.widget.RecyclerView.Adapter} is not part of this {@link androidx.recyclerview.widget.RecyclerView.Adapter},
         * {@link androidx.recyclerview.widget.RecyclerView#NO_POSITION} is returned.
         *
         ...
         *                   returned.
         * @param localPosition The position of the given {@link androidx.recyclerview.widget.RecyclerView.ViewHolder} in this
         * {@link androidx.recyclerview.widget.RecyclerView.Adapter}.
         *
         * @return The local position of the given {@link androidx.recyclerview.widget.RecyclerView.ViewHolder} in this {@link androidx.recyclerview.widget.RecyclerView.Adapter}
         * or {@link androidx.recyclerview.widget.RecyclerView#NO_POSITION} if the {@link androidx.recyclerview.widget.RecyclerView.ViewHolder} is not bound to an item
         * or the given {@link androidx.recyclerview.widget.RecyclerView.Adapter} is not part of this Adapter (if this Adapter merges other
         * adapters).
         */
        public int findRelativeAdapterPositionIn(
                @NonNull androidx.recyclerview.widget.RecyclerView.Adapter<? extends androidx.recyclerview.widget.RecyclerView.ViewHolder> adapter,
         ...
         * {@link androidx.recyclerview.widget.RecyclerView.ViewHolder} and initializes some private fields to be used by RecyclerView.
         *
        ...
        /**
         * This method internally calls {@link #onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder, int)} to update the
         * {@link androidx.recyclerview.widget.RecyclerView.ViewHolder} contents with the item at the given position and also sets up some
         * private fields to be used by RecyclerView.
         *
         * Adapters that merge other adapters should use
         * {@link #bindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder, int)} when calling nested adapters so that
         * RecyclerView can track which adapter bound the {@link androidx.recyclerview.widget.RecyclerView.ViewHolder} to return the correct
         * position from {@link androidx.recyclerview.widget.RecyclerView.ViewHolder#getBindingAdapterPosition()} method.
         * They should also override
         * the {@link #findRelativeAdapterPositionIn(androidx.recyclerview.widget.RecyclerView.Adapter, androidx.recyclerview.widget.RecyclerView.ViewHolder, int)} method.
         *
        ...
        public final void bindViewHolder(@NonNull VH holder, int position) {
            ...
            if (rootBind) {
                ...
                holder.setFlags(androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_BOUND,
                        androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_BOUND | androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_UPDATE | androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_INVALID
                                | androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_ADAPTER_POSITION_UNKNOWN);
         ...
         *
         * <p>A view is recycled when a {@link androidx.recyclerview.widget.RecyclerView.LayoutManager} decides that it no longer
         * needs to be attached to its parent {@link androidx.recyclerview.widget.RecyclerView}. This can be because it has
         ...
         * before being recycled, you can call {@link androidx.recyclerview.widget.RecyclerView.ViewHolder#getBindingAdapterPosition()} to get
         ...
         * {@link #onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder, int)} call when View is rebound to a new position.
         * For this reason, RecyclerView leaves the decision to the Adapter and uses the return
         * value of this method to decide whether the View should be recycled or not.
         * <p>
         * Note that when all animations are created by {@link androidx.recyclerview.widget.RecyclerView.ItemAnimator}, you
         * should never receive this callback because RecyclerView keeps those Views as children
         * until their animations are complete. This callback is useful when children of the item
         * views create animations which may not be easy to implement using an {@link androidx.recyclerview.widget.RecyclerView.ItemAnimator}.
         * <p>
         ...
         * {@link #onViewDetachedFromWindow(androidx.recyclerview.widget.RecyclerView.ViewHolder) onViewDetachedFromWindow}
         ...
         * {@link #unregisterAdapterDataObserver(androidx.recyclerview.widget.RecyclerView.AdapterDataObserver)
         * unregistering} those observers when finished.</p>
         *
         * @param observer Observer to register
         * @see #unregisterAdapterDataObserver(androidx.recyclerview.widget.RecyclerView.AdapterDataObserver)
         */
        public void registerAdapterDataObserver(@NonNull androidx.recyclerview.widget.RecyclerView.AdapterDataObserver observer) {
         ...
         * @see #registerAdapterDataObserver(androidx.recyclerview.widget.RecyclerView.AdapterDataObserver)
         */
        public void unregisterAdapterDataObserver(@NonNull androidx.recyclerview.widget.RecyclerView.AdapterDataObserver observer) {
         ...
         * @see #onDetachedFromRecyclerView(androidx.recyclerview.widget.RecyclerView)
         */
         ...
         * @see #onAttachedToRecyclerView(androidx.recyclerview.widget.RecyclerView)
         */
         ...
         * and may be passed to adapter's {@link #onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder, int, List)} if the
         * item is already represented by a ViewHolder and it will be rebound to the same
         * ViewHolder. A notifyItemRangeChanged() with null payload will clear all existing
         * payloads on that item and prevent future payload until
         * {@link #onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder, int, List)} is called. Adapter should not assume
         ...
         * how State is restored is up to the {@link androidx.recyclerview.widget.RecyclerView.LayoutManager}. All default LayoutManagers
         * will override current state with restored state when state restoration happens (unless
         * an explicit call to {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#scrollToPosition(int)} is made).
         * <p>
    ...
    public abstract static class LayoutManager {
        ...
        private final ViewBoundsCheck.Callback mHorizontalBoundCheckCallback =
                new ViewBoundsCheck.Callback() {
                    ...
                    public View getChildAt(int index) {
                        return androidx.recyclerview.widget.RecyclerView.LayoutManager.this.getChildAt(index);
                    }
                    ...
                    public int getChildStart(View view) {
                        ...
                        return androidx.recyclerview.widget.RecyclerView.LayoutManager.this.getDecoratedLeft(view) - params.leftMargin;
                    }
                    ...
                    public int getChildEnd(View view) {
                        final androidx.recyclerview.widget.RecyclerView.LayoutParams params = (androidx.recyclerview.widget.RecyclerView.LayoutParams)
                                view.getLayoutParams();
                        return androidx.recyclerview.widget.RecyclerView.LayoutManager.this.getDecoratedRight(view) + params.rightMargin;
                    }
                };
        ...
        private final ViewBoundsCheck.Callback mVerticalBoundCheckCallback =
                new ViewBoundsCheck.Callback() {
                    ...
                    @Override
                    public int getParentEnd() {
                        return androidx.recyclerview.widget.RecyclerView.LayoutManager.this.getHeight()
                                - androidx.recyclerview.widget.RecyclerView.LayoutManager.this.getPaddingBottom();
                    }
                    ...
                    public int getChildStart(View view) {
                        final androidx.recyclerview.widget.RecyclerView.LayoutParams params = (androidx.recyclerview.widget.RecyclerView.LayoutParams)
                                view.getLayoutParams();
                        return androidx.recyclerview.widget.RecyclerView.LayoutManager.this.getDecoratedTop(view) - params.topMargin;
                    }
                    ...
                    public int getChildEnd(View view) {
                        final androidx.recyclerview.widget.RecyclerView.LayoutParams params = (androidx.recyclerview.widget.RecyclerView.LayoutParams)
                                view.getLayoutParams();
                        return androidx.recyclerview.widget.RecyclerView.LayoutManager.this.getDecoratedBottom(view) + params.bottomMargin;
                    }
                };
         ...
         * requested by a {@link #collectInitialPrefetchPositions(int, androidx.recyclerview.widget.RecyclerView.LayoutManager.LayoutPrefetchRegistry)} or
         * {@link #collectAdjacentPrefetchPositions(int, int, androidx.recyclerview.widget.RecyclerView.State, androidx.recyclerview.widget.RecyclerView.LayoutManager.LayoutPrefetchRegistry)} call.
         *
         * If expanded by a {@link #collectInitialPrefetchPositions(int, androidx.recyclerview.widget.RecyclerView.LayoutManager.LayoutPrefetchRegistry)},
         ...
         *
         * @see androidx.recyclerview.widget.RecyclerView.LayoutManager#collectAdjacentPrefetchPositions(int, int, androidx.recyclerview.widget.RecyclerView.State, androidx.recyclerview.widget.RecyclerView.LayoutManager.LayoutPrefetchRegistry)
         * @see androidx.recyclerview.widget.RecyclerView.LayoutManager#collectInitialPrefetchPositions(int, androidx.recyclerview.widget.RecyclerView.LayoutManager.LayoutPrefetchRegistry)
         */
         ...
         * measurement specs that were passed into {@link androidx.recyclerview.widget.RecyclerView#onMeasure(int, int)}. It is
         ...
         * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#onLayoutChildren(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)} in the execution of
         * {@link androidx.recyclerview.widget.RecyclerView#onMeasure(int, int)}.
         * <p>
         ...
         * {@link androidx.recyclerview.widget.RecyclerView} or if it should be done by the LayoutManager's implementation of
         * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#onMeasure(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State, int, int)}.
         *
         ...
         * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#onMeasure(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State, int, int)} should not be overridden.
         * <p>
         ...
         * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#onLayoutChildren(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)} during a call to
         * {@link androidx.recyclerview.widget.RecyclerView#onMeasure(int, int)}, and then calculating desired dimensions based
         ...
         * More specifically:
         * <ol>
         * <li>When {@link androidx.recyclerview.widget.RecyclerView#onMeasure(int, int)} is called, if the provided measure
         ...
         * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#onMeasure(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State, int, int)} for backwards compatibility
         ...
         * call {@link #onLayoutChildren(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)} with {@link androidx.recyclerview.widget.RecyclerView.State#isPreLayout()} set to
         ...
         * {@link #onLayoutChildren(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)} with {@link androidx.recyclerview.widget.RecyclerView.State#isMeasuring()} set to
         * {@code true} and {@link androidx.recyclerview.widget.RecyclerView.State#isPreLayout()} set to {@code false}. The LayoutManager can
         ...
         * <li>Any following calls to {@link androidx.recyclerview.widget.RecyclerView#onMeasure(int, int)} will run
         * {@link #onLayoutChildren(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)} with {@link androidx.recyclerview.widget.RecyclerView.State#isMeasuring()} set to
         * {@code true} and {@link androidx.recyclerview.widget.RecyclerView.State#isPreLayout()} set to {@code false}. RecyclerView will
         ...
         * {@link #onLayoutChildren(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)} call as if it is the last one.</li>
         ...
         * that information. It may still decide to call {@link #onLayoutChildren(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)}
         ...
         * mechanism of {@link androidx.recyclerview.widget.RecyclerView} or <code>False</code> if it should be done by the
         * LayoutManager's implementation of
         * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#onMeasure(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State, int, int)}.
         * @see #setMeasuredDimension(Rect, int, int)
         * @see #onMeasure(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State, int, int)
         */
         ...
         * behavioral contracts outlined in {@link #onLayoutChildren(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)}.
         * <p>
         ...
         * {@link androidx.recyclerview.widget.RecyclerView#setItemAnimator(androidx.recyclerview.widget.RecyclerView.ItemAnimator) ItemAnimator} set on the
         ...
         * traversals.</p>
         *
         * <p>The LayoutManager should call {@link androidx.recyclerview.widget.RecyclerView.LayoutManager.LayoutPrefetchRegistry#addPosition(int, int)} for
         ...
         * @see #isItemPrefetchEnabled()
         * @see #collectInitialPrefetchPositions(int, androidx.recyclerview.widget.RecyclerView.LayoutManager.LayoutPrefetchRegistry)
         */
        public void collectAdjacentPrefetchPositions(int dx, int dy, androidx.recyclerview.widget.RecyclerView.State state,
                                                     androidx.recyclerview.widget.RecyclerView.LayoutManager.LayoutPrefetchRegistry layoutPrefetchRegistry) {
        }
         ...
         * @param layoutPrefetchRegistry PrefetchRegistry to add prefetch entries into.
         * @see #isItemPrefetchEnabled()
         * @see #collectAdjacentPrefetchPositions(int, int, androidx.recyclerview.widget.RecyclerView.State, androidx.recyclerview.widget.RecyclerView.LayoutManager.LayoutPrefetchRegistry)
         */
        public void collectInitialPrefetchPositions(int adapterItemCount,
                                                    androidx.recyclerview.widget.RecyclerView.LayoutManager.LayoutPrefetchRegistry layoutPrefetchRegistry) {
        }

        void dispatchAttachedToWindow(androidx.recyclerview.widget.RecyclerView view) {
            mIsAttachedToWindow = true;
            onAttachedToWindow(view);
        }

        void dispatchDetachedFromWindow(androidx.recyclerview.widget.RecyclerView view, androidx.recyclerview.widget.RecyclerView.Recycler recycler) {
         ...
         * call {@link #onLayoutChildren(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)} if nothing has changed and a layout was
         ...
         * @see #onDetachedFromWindow(androidx.recyclerview.widget.RecyclerView, androidx.recyclerview.widget.RecyclerView.Recycler)
         */
        @CallSuper
        ...
        /**
         * @deprecated override {@link #onDetachedFromWindow(androidx.recyclerview.widget.RecyclerView, androidx.recyclerview.widget.RecyclerView.Recycler)}
         */
        @Deprecated
         ...
         * call {@link androidx.recyclerview.widget.RecyclerView#requestLayout()} to ensure that it is re-laid out when
         ...
         *                 keeping them around.
         * @see #onAttachedToWindow(androidx.recyclerview.widget.RecyclerView)
         */
        @CallSuper
        public void onDetachedFromWindow(androidx.recyclerview.widget.RecyclerView view, androidx.recyclerview.widget.RecyclerView.Recycler recycler) {
         ...
         * normal layout operation during {@link #onLayoutChildren(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)}, the
         ...
         * {@link #onLayoutChildren(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)}. Supporting predictive animations
         * means that {@link #onLayoutChildren(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)} will be called twice;
         ...
         * appropriately. Also, {@link androidx.recyclerview.widget.RecyclerView.LayoutParams#isItemRemoved() removed} items will
         ...
         * multiple {@link #onLayoutChildren(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)} calls due to animations or
         * layout measurement but it will include only one {@link #onLayoutCompleted(androidx.recyclerview.widget.RecyclerView.State)} call.
         ...
         * {@link androidx.recyclerview.widget.RecyclerView.LayoutParams} for this purpose.</p>
         *
         * <p><em>Important:</em> if you use your own custom <code>LayoutParams</code> type
         * you must also override
         * {@link #checkLayoutParams(androidx.recyclerview.widget.RecyclerView.LayoutParams)},
         ...
         */
        public androidx.recyclerview.widget.RecyclerView.LayoutParams generateLayoutParams(ViewGroup.LayoutParams lp) {
            if (lp instanceof androidx.recyclerview.widget.RecyclerView.LayoutParams) {
                return new androidx.recyclerview.widget.RecyclerView.LayoutParams((androidx.recyclerview.widget.RecyclerView.LayoutParams) lp);
            } else if (lp instanceof MarginLayoutParams) {
                return new androidx.recyclerview.widget.RecyclerView.LayoutParams((MarginLayoutParams) lp);
            } else {
                return new androidx.recyclerview.widget.RecyclerView.LayoutParams(lp);
            }
        }
        ...
        public androidx.recyclerview.widget.RecyclerView.LayoutParams generateLayoutParams(Context c, AttributeSet attrs) {
            return new androidx.recyclerview.widget.RecyclerView.LayoutParams(c, attrs);
        }
         ...
         */
        public int scrollHorizontallyBy(int dx, androidx.recyclerview.widget.RecyclerView.Recycler recycler, androidx.recyclerview.widget.RecyclerView.State state) {
            return 0;
        }
         ...
         */
        public int scrollVerticallyBy(int dy, androidx.recyclerview.widget.RecyclerView.Recycler recycler, androidx.recyclerview.widget.RecyclerView.State state) {
            return 0;
        }
         ...
         * <p>To support smooth scrolling, override this method, create your {@link androidx.recyclerview.widget.RecyclerView.SmoothScroller}
         * instance and call {@link #startSmoothScroll(androidx.recyclerview.widget.RecyclerView.SmoothScroller)}.
         * </p>
         *
         ...
         * @param position     Scroll to this adapter position.
         */
        public void smoothScrollToPosition(androidx.recyclerview.widget.RecyclerView recyclerView, androidx.recyclerview.widget.RecyclerView.State state,
                                           int position) {
            Log.e(TAG, "You must override smoothScrollToPosition to support smooth scrolling");
        }

        /**
         * Starts a smooth scroll using the provided {@link androidx.recyclerview.widget.RecyclerView.SmoothScroller}.
         *
        ...
        /**
         * Ends all animations on the view created by the {@link androidx.recyclerview.widget.RecyclerView.ItemAnimator}.
         *
         * @param view The View for which the animations should be ended.
         * @see androidx.recyclerview.widget.RecyclerView.ItemAnimator#endAnimations()
         */
        ...
        /**
         * To be called only during {@link #onLayoutChildren(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)} to add a view
         * to the layout that is known to be going away, either because it has been
         * {@link androidx.recyclerview.widget.RecyclerView.Adapter#notifyItemRemoved(int) removed} or because it is actually not in the
         ...
         * use this method to add views obtained from a {@link androidx.recyclerview.widget.RecyclerView.Recycler} using
         * {@link androidx.recyclerview.widget.RecyclerView.Recycler#getViewForPosition(int)}.
         *
         ...
         * {@link androidx.recyclerview.widget.RecyclerView.Recycler#recycleView(android.view.View)}.
         *
         ...
         * @see androidx.recyclerview.widget.RecyclerView#getChildViewHolder(View)
         * @see androidx.recyclerview.widget.RecyclerView#findContainingViewHolder(View)
         */
        @Nullable
        public View findContainingItemView(@NonNull View view) {
            if (mRecyclerView == null) {
         ...
         * will want to use {@link #detachAndScrapView(android.view.View, androidx.recyclerview.widget.RecyclerView.Recycler)}
         ...
         * {@link #attachView(android.view.View, int, androidx.recyclerview.widget.RecyclerView.LayoutParams) reattach}
         ...
         * {@link #detachAndScrapView(android.view.View, androidx.recyclerview.widget.RecyclerView.Recycler)}  scrapped}.
         *
         * @param child Child to reattach
         * @param index Intended child index for child
         * @param lp    LayoutParams for child
         */
        public void attachView(@NonNull View child, int index, androidx.recyclerview.widget.RecyclerView.LayoutParams lp) {
            androidx.recyclerview.widget.RecyclerView.ViewHolder vh = getChildViewHolderInt(child);
            if (vh.isRemoved()) {
        ...
        public void attachView(@NonNull View child, int index) {
            attachView(child, index, (androidx.recyclerview.widget.RecyclerView.LayoutParams) child.getLayoutParams());
        }
        ...
        /**
         * Detach a child view and add it to a {@link androidx.recyclerview.widget.RecyclerView.Recycler Recycler's} scrap heap.
         *
         ...
         */
        public void detachAndScrapView(@NonNull View child, @NonNull androidx.recyclerview.widget.RecyclerView.Recycler recycler) {
         ...
         * @param recycler Recycler to deposit the new scrap view into
         */
        public void detachAndScrapViewAt(int index, @NonNull androidx.recyclerview.widget.RecyclerView.Recycler recycler) {
            final View child = getChildAt(index);
            scrapOrRecycleView(recycler, index, child);
        }
         ...
         */
        public void removeAndRecycleView(@NonNull View child, @NonNull androidx.recyclerview.widget.RecyclerView.Recycler recycler) {
            removeView(child);
         ...
         * @param recycler Recycler to use to recycle child
         */
        public void removeAndRecycleViewAt(int index, @NonNull androidx.recyclerview.widget.RecyclerView.Recycler recycler) {
         ...
         *
         * <p>This value is usually equal to the laid out width of the {@link androidx.recyclerview.widget.RecyclerView} but may
         * reflect the current {@link android.view.View.MeasureSpec} width if the
         * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager} is using AutoMeasure and the RecyclerView is in the process of
         ...
         *
         * <p>This value is usually equal to the laid out height of the {@link androidx.recyclerview.widget.RecyclerView} but may
         ...
         * {@link androidx.recyclerview.widget.RecyclerView.State#getItemCount() State#getItemCount()}. In methods where {@link androidx.recyclerview.widget.RecyclerView.State} is
         * available, you should use {@link androidx.recyclerview.widget.RecyclerView.State#getItemCount() State#getItemCount()} instead.
         * For more details, check the documentation for
         * {@link androidx.recyclerview.widget.RecyclerView.State#getItemCount() State#getItemCount()}.
         *
         * @return The number of items in the bound adapter
         * @see androidx.recyclerview.widget.RecyclerView.State#getItemCount()
         */
        public int getItemCount() {
            final androidx.recyclerview.widget.RecyclerView.Adapter a = mRecyclerView != null ? mRecyclerView.getAdapter() : null;
         ...
         * recyling. Methods like {@link #removeAndRecycleAllViews(androidx.recyclerview.widget.RecyclerView.Recycler)} will ignore the child
        ...
        public void ignoreView(@NonNull View view) {
            ...
            final androidx.recyclerview.widget.RecyclerView.ViewHolder vh = getChildViewHolderInt(view);
            vh.addFlags(androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_IGNORE);
        ...
        public void stopIgnoringView(@NonNull View view) {
            ...
            vh.stopIgnoring();
            vh.resetInternal();
            vh.addFlags(androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_INVALID);
        }
         ...
         */
        public void detachAndScrapAttachedViews(@NonNull androidx.recyclerview.widget.RecyclerView.Recycler recycler) {
            final int childCount = getChildCount();
            for (int i = childCount - 1; i >= 0; i--) {
        ...
        private void scrapOrRecycleView(androidx.recyclerview.widget.RecyclerView.Recycler recycler, int index, View view) {
            final androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder = getChildViewHolderInt(view);
            if (viewHolder.shouldIgnore()) {
                if (DEBUG) {
        ...
        void removeAndRecycleScrapInt(androidx.recyclerview.widget.RecyclerView.Recycler recycler) {
            ...
            for (int i = scrapCount - 1; i >= 0; i--) {
                ...
                final androidx.recyclerview.widget.RecyclerView.ViewHolder vh = getChildViewHolderInt(scrap);
                if (vh.shouldIgnore()) {
                    continue;
                }
         ...
         */
        boolean shouldReMeasureChild(View child, int widthSpec, int heightSpec, androidx.recyclerview.widget.RecyclerView.LayoutParams lp) {
         ...
         */
        boolean shouldMeasureChild(View child, int widthSpec, int heightSpec, androidx.recyclerview.widget.RecyclerView.LayoutParams lp) {
        ...
        public static int getChildMeasureSpec(int parentSize, int padding, int childDimension,
            ...
            if (canScroll) {
                ...
                if (childDimension >= 0) {
                    resultSize = childDimension;
                    resultMode = MeasureSpec.EXACTLY;
                } else if (childDimension == androidx.recyclerview.widget.RecyclerView.LayoutParams.MATCH_PARENT) {
                    resultSize = size;
                    // TODO this should be my spec.
                    resultMode = MeasureSpec.EXACTLY;
                } else if (childDimension == androidx.recyclerview.widget.RecyclerView.LayoutParams.WRAP_CONTENT) {
                    resultSize = size;
         ...
         * any insets applied by {@link androidx.recyclerview.widget.RecyclerView.ItemDecoration ItemDecorations}.
         *
         * @param child Child view to query
        ...
        public int getDecoratedMeasuredWidth(@NonNull View child) {
            final Rect insets = ((androidx.recyclerview.widget.RecyclerView.LayoutParams) child.getLayoutParams()).mDecorInsets;
         ...
         * include any current {@link androidx.recyclerview.widget.RecyclerView.ItemDecoration ItemDecorations}.
         *
        ...
        /**
         * Lay out the given child view within the RecyclerView using coordinates that
         * include any current {@link androidx.recyclerview.widget.RecyclerView.ItemDecoration ItemDecorations} and margins.
         *
         * <p>LayoutManagers should prefer working in sizes and coordinates that include
         * item decoration insets whenever possible. This allows the LayoutManager to effectively
         * ignore decoration insets within measurement and layout code. See the following
        ...
        public void getTransformedBoundingBox(@NonNull View child, boolean includeDecorInsets,
            ...
            if (includeDecorInsets) {
                Rect insets = ((androidx.recyclerview.widget.RecyclerView.LayoutParams) child.getLayoutParams()).mDecorInsets;
         ...
         */
        public void getDecoratedBoundsWithMargins(@NonNull View view, @NonNull Rect outBounds) {
            androidx.recyclerview.widget.RecyclerView.getDecoratedBoundsWithMarginsInt(view, outBounds);
        }

        /**
         * Returns the left edge of the given child view within its parent, offset by any applied
         * {@link androidx.recyclerview.widget.RecyclerView.ItemDecoration ItemDecorations}.
         *
        ...
        public int getTopDecorationHeight(@NonNull View child) {
            return ((androidx.recyclerview.widget.RecyclerView.LayoutParams) child.getLayoutParams()).mDecorInsets.top;
        }
        ...
        public int getBottomDecorationHeight(@NonNull View child) {
            return ((androidx.recyclerview.widget.RecyclerView.LayoutParams) child.getLayoutParams()).mDecorInsets.bottom;
        }
        ...
        public int getLeftDecorationWidth(@NonNull View child) {
            return ((androidx.recyclerview.widget.RecyclerView.LayoutParams) child.getLayoutParams()).mDecorInsets.left;
        }
        ...
        public int getRightDecorationWidth(@NonNull View child) {
            return ((androidx.recyclerview.widget.RecyclerView.LayoutParams) child.getLayoutParams()).mDecorInsets.right;
        }
        ...
        public View onFocusSearchFailed(@NonNull View focused, int direction,
                                        @NonNull androidx.recyclerview.widget.RecyclerView.Recycler recycler, @NonNull androidx.recyclerview.widget.RecyclerView.State state) {
            return null;
        }
         ...
         * then {@link #onFocusSearchFailed(View, int, androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)}
         ...
         */
        public boolean requestChildRectangleOnScreen(@NonNull androidx.recyclerview.widget.RecyclerView parent,
         ...
         */
        private boolean isFocusedChildVisibleAfterScrolling(androidx.recyclerview.widget.RecyclerView parent, int dx, int dy) {
        ...
        /**
         * @deprecated Use {@link #onRequestChildFocus(androidx.recyclerview.widget.RecyclerView, androidx.recyclerview.widget.RecyclerView.State, View, View)}
         */
        @Deprecated
        public boolean onRequestChildFocus(@NonNull androidx.recyclerview.widget.RecyclerView parent, @NonNull View child,
         ...
         */
        public boolean onRequestChildFocus(@NonNull androidx.recyclerview.widget.RecyclerView parent, @NonNull androidx.recyclerview.widget.RecyclerView.State state,
         ...
         * {@link androidx.recyclerview.widget.RecyclerView#setAdapter(androidx.recyclerview.widget.RecyclerView.Adapter)} or
         * {@link androidx.recyclerview.widget.RecyclerView#swapAdapter(androidx.recyclerview.widget.RecyclerView.Adapter, boolean)}. The LayoutManager may use this
         ...
         *                   {@link androidx.recyclerview.widget.RecyclerView#setAdapter(androidx.recyclerview.widget.RecyclerView.Adapter)} is called with
         *                   {@code null}.
         */
        public void onAdapterChanged(@Nullable androidx.recyclerview.widget.RecyclerView.Adapter oldAdapter, @Nullable androidx.recyclerview.widget.RecyclerView.Adapter newAdapter) {
        }
         ...
         */
        public boolean onAddFocusables(@NonNull androidx.recyclerview.widget.RecyclerView recyclerView,
                                       @NonNull ArrayList<View> views, int direction, int focusableMode) {
            return false;
        }

        /**
         * Called in response to a call to {@link androidx.recyclerview.widget.RecyclerView.Adapter#notifyDataSetChanged()} or
         * {@link androidx.recyclerview.widget.RecyclerView#swapAdapter(androidx.recyclerview.widget.RecyclerView.Adapter, boolean)} ()} and signals that the the entire
         * data set has changed.
         */
        public void onItemsChanged(@NonNull androidx.recyclerview.widget.RecyclerView recyclerView) {
        }
         ...
         */
        public void onItemsAdded(@NonNull androidx.recyclerview.widget.RecyclerView recyclerView, int positionStart,
                                 int itemCount) {
        }
         ...
         */
        public void onItemsRemoved(@NonNull androidx.recyclerview.widget.RecyclerView recyclerView, int positionStart,
                                   int itemCount) {
        }

        /**
         * Called when items have been changed in the adapter.
         * To receive payload,  override {@link #onItemsUpdated(androidx.recyclerview.widget.RecyclerView, int, int, Object)}
         * instead, then this callback will not be invoked.
         */
        public void onItemsUpdated(@NonNull androidx.recyclerview.widget.RecyclerView recyclerView, int positionStart,
                                   int itemCount) {
        }

        /**
         * Called when items have been changed in the adapter and with optional payload.
         * Default implementation calls {@link #onItemsUpdated(androidx.recyclerview.widget.RecyclerView, int, int)}.
         */
        public void onItemsUpdated(@NonNull androidx.recyclerview.widget.RecyclerView recyclerView, int positionStart,
         ...
         * operation. This callback is only called if and only if {@link androidx.recyclerview.widget.RecyclerView.Adapter#notifyItemMoved}
         * is called.
         */
        public void onItemsMoved(@NonNull androidx.recyclerview.widget.RecyclerView recyclerView, int from, int to,
                                 int itemCount) {
         ...
         *
         * <p>Read {@link androidx.recyclerview.widget.RecyclerView#computeHorizontalScrollExtent()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current state of RecyclerView
         * @return The horizontal extent of the scrollbar's thumb
         * @see androidx.recyclerview.widget.RecyclerView#computeHorizontalScrollExtent()
         */
        public int computeHorizontalScrollExtent(@NonNull androidx.recyclerview.widget.RecyclerView.State state) {
            return 0;
        }
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link androidx.recyclerview.widget.RecyclerView#computeHorizontalScrollOffset()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerView where you can find total item count
         * @return The horizontal offset of the scrollbar's thumb
         * @see androidx.recyclerview.widget.RecyclerView#computeHorizontalScrollOffset()
         */
        public int computeHorizontalScrollOffset(@NonNull androidx.recyclerview.widget.RecyclerView.State state) {
            return 0;
        }
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link androidx.recyclerview.widget.RecyclerView#computeHorizontalScrollRange()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerView where you can find total item count
         * @return The total horizontal range represented by the vertical scrollbar
         * @see androidx.recyclerview.widget.RecyclerView#computeHorizontalScrollRange()
         */
        public int computeHorizontalScrollRange(@NonNull androidx.recyclerview.widget.RecyclerView.State state) {
            return 0;
        }
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link androidx.recyclerview.widget.RecyclerView#computeVerticalScrollExtent()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current state of RecyclerView
         * @return The vertical extent of the scrollbar's thumb
         * @see androidx.recyclerview.widget.RecyclerView#computeVerticalScrollExtent()
         */
        public int computeVerticalScrollExtent(@NonNull androidx.recyclerview.widget.RecyclerView.State state) {
            return 0;
        }
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link androidx.recyclerview.widget.RecyclerView#computeVerticalScrollOffset()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerView where you can find total item count
         * @return The vertical offset of the scrollbar's thumb
         * @see androidx.recyclerview.widget.RecyclerView#computeVerticalScrollOffset()
         */
        public int computeVerticalScrollOffset(@NonNull androidx.recyclerview.widget.RecyclerView.State state) {
            return 0;
        }
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link androidx.recyclerview.widget.RecyclerView#computeVerticalScrollRange()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerView where you can find total item count
         * @return The total vertical range represented by the vertical scrollbar
         * @see androidx.recyclerview.widget.RecyclerView#computeVerticalScrollRange()
         */
        public int computeVerticalScrollRange(@NonNull androidx.recyclerview.widget.RecyclerView.State state) {
            return 0;
        }
         ...
         * @see #setMeasuredDimension(int, int)
         */
        public void onMeasure(@NonNull androidx.recyclerview.widget.RecyclerView.Recycler recycler, @NonNull androidx.recyclerview.widget.RecyclerView.State state, int widthSpec,
                              int heightSpec) {
            mRecyclerView.defaultOnMeasure(widthSpec, heightSpec);
        }
         ...
         * restore State. See {@link androidx.recyclerview.widget.RecyclerView.Adapter#getStateRestorationPolicy()} for more information.
         *
         ...
         * <p>
         * If you want to clean cached views as well, you should call {@link androidx.recyclerview.widget.RecyclerView.Recycler#clear()} too.
         * <p>
         * If a View is marked as "ignored", it is not removed nor recycled.
         *
         * @param recycler Recycler to use to recycle children
         * @see #removeAndRecycleView(View, androidx.recyclerview.widget.RecyclerView.Recycler)
         * @see #removeAndRecycleViewAt(int, androidx.recyclerview.widget.RecyclerView.Recycler)
         * @see #ignoreView(View)
         */
        public void removeAndRecycleAllViews(@NonNull androidx.recyclerview.widget.RecyclerView.Recycler recycler) {
         ...
         * <p>
         * You should override
         * {@link #getRowCountForAccessibility(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)},
         * {@link #getColumnCountForAccessibility(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)},
         * {@link #isLayoutHierarchical(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)} and
         * {@link #getSelectionModeForAccessibility(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)} for
         ...
         * @see #getRowCountForAccessibility(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)
         * @see #getColumnCountForAccessibility(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)
         * @see #isLayoutHierarchical(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)
         * @see #getSelectionModeForAccessibility(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)
         */
        public void onInitializeAccessibilityNodeInfo(@NonNull androidx.recyclerview.widget.RecyclerView.Recycler recycler,
                                                      @NonNull androidx.recyclerview.widget.RecyclerView.State state, @NonNull AccessibilityNodeInfoCompat info) {
         ...
         */
        public void onInitializeAccessibilityEvent(@NonNull androidx.recyclerview.widget.RecyclerView.Recycler recycler, @NonNull androidx.recyclerview.widget.RecyclerView.State state,
        ...
        void onInitializeAccessibilityNodeInfoForItem(View host, AccessibilityNodeInfoCompat info) {
            final androidx.recyclerview.widget.RecyclerView.ViewHolder vh = getChildViewHolderInt(host);
         ...
         * android.view.accessibility.AccessibilityNodeInfo)
         */
        public void onInitializeAccessibilityNodeInfoForItem(@NonNull androidx.recyclerview.widget.RecyclerView.Recycler recycler,
                                                             @NonNull androidx.recyclerview.widget.RecyclerView.State state, @NonNull View host,
         ...
         * at all. For example, if there is not any {@link androidx.recyclerview.widget.RecyclerView.ItemAnimator} set, RecyclerView will
         ...
         * {@link AccessibilityNodeInfoCompat.CollectionInfoCompat#SELECTION_MODE_NONE}.
         */
        public int getSelectionModeForAccessibility(@NonNull androidx.recyclerview.widget.RecyclerView.Recycler recycler,
         ...
         */
        public int getRowCountForAccessibility(@NonNull androidx.recyclerview.widget.RecyclerView.Recycler recycler, @NonNull androidx.recyclerview.widget.RecyclerView.State state) {
            return -1;
        }
         ...
         * @return The number of rows in LayoutManager for accessibility.
         */
        public int getColumnCountForAccessibility(@NonNull androidx.recyclerview.widget.RecyclerView.Recycler recycler,
                                                  @NonNull androidx.recyclerview.widget.RecyclerView.State state) {
            return -1;
        }
         ...
         */
        public boolean isLayoutHierarchical(@NonNull androidx.recyclerview.widget.RecyclerView.Recycler recycler, @NonNull androidx.recyclerview.widget.RecyclerView.State state) {
            return false;
        }
         ...
         */
        public boolean performAccessibilityAction(@NonNull androidx.recyclerview.widget.RecyclerView.Recycler recycler, @NonNull androidx.recyclerview.widget.RecyclerView.State state,
         ...
         * @see View#performAccessibilityAction(int, android.os.Bundle)
         */
        public boolean performAccessibilityActionForItem(@NonNull androidx.recyclerview.widget.RecyclerView.Recycler recycler,
                                                         @NonNull androidx.recyclerview.widget.RecyclerView.State state, @NonNull View view, int action, @Nullable Bundle args) {
            return false;
        }
         ...
         */
        public static androidx.recyclerview.widget.RecyclerView.LayoutManager.Properties getProperties(@NonNull Context context,
     ...
     * views (in {@link androidx.recyclerview.widget.RecyclerView.ItemDecoration#onDraw(Canvas, androidx.recyclerview.widget.RecyclerView, androidx.recyclerview.widget.RecyclerView.State) onDraw()}
     * and after the items (in {@link androidx.recyclerview.widget.RecyclerView.ItemDecoration#onDrawOver(Canvas, androidx.recyclerview.widget.RecyclerView,
     * androidx.recyclerview.widget.RecyclerView.State)}.</p>
     */
    public abstract static class ItemDecoration {
        ...
        /**
         * @deprecated Override {@link #onDraw(Canvas, androidx.recyclerview.widget.RecyclerView, androidx.recyclerview.widget.RecyclerView.State)}
         */
        @Deprecated
        public void onDraw(@NonNull Canvas c, @NonNull androidx.recyclerview.widget.RecyclerView parent) {
        }
         ...
         * @param state  The current state of RecyclerView.
         */
        public void onDrawOver(@NonNull Canvas c, @NonNull androidx.recyclerview.widget.RecyclerView parent,
                               @NonNull androidx.recyclerview.widget.RecyclerView.State state) {
            onDrawOver(c, parent);
        }

        /**
         * @deprecated Override {@link #onDrawOver(Canvas, androidx.recyclerview.widget.RecyclerView, androidx.recyclerview.widget.RecyclerView.State)}
         */
        @Deprecated
        public void onDrawOver(@NonNull Canvas c, @NonNull androidx.recyclerview.widget.RecyclerView parent) {
        }
        ...
        /**
         * @deprecated Use {@link #getItemOffsets(Rect, View, androidx.recyclerview.widget.RecyclerView, androidx.recyclerview.widget.RecyclerView.State)}
         */
        @Deprecated
         ...
         * {@link androidx.recyclerview.widget.RecyclerView#getChildAdapterPosition(View)} to get the adapter position of the
         * View.
         *
        ...
        public void getItemOffsets(@NonNull Rect outRect, @NonNull View view,
                                   @NonNull androidx.recyclerview.widget.RecyclerView parent, @NonNull androidx.recyclerview.widget.RecyclerView.State state) {
            getItemOffsets(outRect, ((androidx.recyclerview.widget.RecyclerView.LayoutParams) view.getLayoutParams()).getViewLayoutPosition(),
                    parent);
        }
    }
    ...
    public interface OnItemTouchListener {
         ...
         * the gesture.
         */
        boolean onInterceptTouchEvent(@NonNull androidx.recyclerview.widget.RecyclerView rv, @NonNull MotionEvent e);
         ...
         *          the RecyclerView's coordinate system.
         */
        void onTouchEvent(@NonNull androidx.recyclerview.widget.RecyclerView rv, @NonNull MotionEvent e);
    ...
    /**
     * An implementation of {@link androidx.recyclerview.widget.RecyclerView.OnItemTouchListener} that has empty method bodies
     ...
     * <p>
     *
     * @see androidx.recyclerview.widget.RecyclerView#addOnScrollListener(androidx.recyclerview.widget.RecyclerView.OnScrollListener)
     * @see androidx.recyclerview.widget.RecyclerView#clearOnChildAttachStateChangeListeners()
     */
     ...
     * a view is recycled.
     *
     * @see androidx.recyclerview.widget.RecyclerView#setRecyclerListener(androidx.recyclerview.widget.RecyclerView.RecyclerListener)
     */
    public interface RecyclerListener {
         ...
         */
        void onViewRecycled(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder holder);
    }
     ...
     *
     * <p>{@link androidx.recyclerview.widget.RecyclerView.Adapter} implementations should subclass ViewHolder and add fields for caching
     * potentially expensive {@link View#findViewById(int)} results.</p>
     *
     * <p>While {@link androidx.recyclerview.widget.RecyclerView.LayoutParams} belong to the {@link androidx.recyclerview.widget.RecyclerView.LayoutManager},
     * {@link androidx.recyclerview.widget.RecyclerView.ViewHolder ViewHolders} belong to the adapter. Adapters should feel free to use
    ...
    public abstract static class ViewHolder {
        ...
        void flagRemovedAndOffsetPosition(int mNewPosition, int offset, boolean applyToPreLayout) {
            addFlags(androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_REMOVED);
        ...
        void offsetPosition(int offset, boolean applyToPreLayout) {
            ...
            if (itemView.getLayoutParams() != null) {
                ((androidx.recyclerview.widget.RecyclerView.LayoutParams) itemView.getLayoutParams()).mInsetsDirty = true;
            }
        }
         ...
         * positions. All methods in {@link androidx.recyclerview.widget.RecyclerView.LayoutManager}, {@link androidx.recyclerview.widget.RecyclerView.State},
         * {@link androidx.recyclerview.widget.RecyclerView.Recycler} that receive a position expect it to be the layout position
         * of the item.
         * <p>
         * If LayoutManager needs to call an external method that requires the adapter position of
         * the item, it can use {@link #getAbsoluteAdapterPosition()} or
         * {@link androidx.recyclerview.widget.RecyclerView.Recycler#convertPreLayoutPositionToPostLayout(int)}.
         *
         ...
         * {@link #getBindingAdapterPosition()} or if you want the position as {@link androidx.recyclerview.widget.RecyclerView}
         ...
         * the {@link androidx.recyclerview.widget.RecyclerView.Adapter} that bound it.
         * <p>
         ...
         * <p>
         * Note that if you've called {@link androidx.recyclerview.widget.RecyclerView.Adapter#notifyDataSetChanged()}, until the
         * next layout pass, the return value of this method will be {@link #NO_POSITION}.
         * <p>
         * If the {@link androidx.recyclerview.widget.RecyclerView.Adapter} that bound this {@link androidx.recyclerview.widget.RecyclerView.ViewHolder} is inside another
         * {@link androidx.recyclerview.widget.RecyclerView.Adapter} (e.g. {@link ConcatAdapter}), this position might be different than
         * {@link #getAbsoluteAdapterPosition()}. If you would like to know the position that
         * {@link androidx.recyclerview.widget.RecyclerView} considers (e.g. for saved state), you should use
         * {@link #getAbsoluteAdapterPosition()}.
         *
         * @return The adapter position of the item if it still exists in the adapter.
         * {@link androidx.recyclerview.widget.RecyclerView#NO_POSITION} if item has been removed from the adapter,
         * {@link androidx.recyclerview.widget.RecyclerView.Adapter#notifyDataSetChanged()} has been called after the last
        ...
        public final int getBindingAdapterPosition() {
            ...
            @SuppressWarnings("unchecked")
            androidx.recyclerview.widget.RecyclerView.Adapter<? extends androidx.recyclerview.widget.RecyclerView.ViewHolder> rvAdapter = mOwnerRecyclerView.getAdapter();
            if (rvAdapter == null) {
                return NO_POSITION;
            }
        ...
        /**
         * Returns the Adapter position of the item represented by this ViewHolder with respect to
         * the {@link androidx.recyclerview.widget.RecyclerView}'s {@link androidx.recyclerview.widget.RecyclerView.Adapter}. If the {@link androidx.recyclerview.widget.RecyclerView.Adapter} that bound this
         * {@link androidx.recyclerview.widget.RecyclerView.ViewHolder} is inside another adapter (e.g. {@link ConcatAdapter}), this
         ...
         * next layout pass, the return value of this method will be {@link #NO_POSITION}.
         * <p>
         * Note that if you are querying the position as {@link androidx.recyclerview.widget.RecyclerView} sees, you should use
         * {@link #getAbsoluteAdapterPosition()} (e.g. you want to use it to save scroll
         * state). If you are querying the position to access the {@link androidx.recyclerview.widget.RecyclerView.Adapter} contents,
         * you should use {@link #getBindingAdapterPosition()}.
         *
         * @return The adapter position of the item from {@link androidx.recyclerview.widget.RecyclerView}'s perspective if it
        ...
        /**
         * Returns the {@link androidx.recyclerview.widget.RecyclerView.Adapter} that last bound this {@link androidx.recyclerview.widget.RecyclerView.ViewHolder}.
         * Might return {@code null} if this {@link androidx.recyclerview.widget.RecyclerView.ViewHolder} is not bound to any adapter.
         *
         * @return The {@link androidx.recyclerview.widget.RecyclerView.Adapter} that last bound this {@link androidx.recyclerview.widget.RecyclerView.ViewHolder} or {@code null} if
         * this {@link androidx.recyclerview.widget.RecyclerView.ViewHolder} is not bound by any adapter (e.g. recycled).
         */
        @Nullable
         ...
         *
         * @return The item's id if adapter has stable ids, {@link androidx.recyclerview.widget.RecyclerView#NO_ID}
         * otherwise
         */
        ...
        void setScrapContainer(androidx.recyclerview.widget.RecyclerView.Recycler recycler, boolean isChangeScrap) {
         ...
         */
        void onEnteredHiddenState(androidx.recyclerview.widget.RecyclerView parent) {
         ...
         */
        void onLeftHiddenState(androidx.recyclerview.widget.RecyclerView parent) {
            parent.setChildImportantForAccessibilityInternal(this,
                    mWasImportantForAccessibilityBeforeHidden);
            mWasImportantForAccessibilityBeforeHidden = ViewCompat.IMPORTANT_FOR_ACCESSIBILITY_AUTO;
        }
     ...
     */
    @VisibleForTesting
    boolean setChildImportantForAccessibilityInternal(androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder,
    ...
    void dispatchPendingImportantForAccessibilityChanges() {
        for (int i = mPendingAccessibilityImportanceChange.size() - 1; i >= 0; i--) {
            androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder = mPendingAccessibilityImportanceChange.get(i);
            if (viewHolder.itemView.getParent() != this || viewHolder.shouldIgnore()) {
                continue;
            }
            int state = viewHolder.mPendingAccessibilityState;
            if (state != androidx.recyclerview.widget.RecyclerView.ViewHolder.PENDING_ACCESSIBILITY_STATE_NOT_SET) {
                //noinspection WrongConstant
                ViewCompat.setImportantForAccessibility(viewHolder.itemView, state);
                viewHolder.mPendingAccessibilityState =
                        androidx.recyclerview.widget.RecyclerView.ViewHolder.PENDING_ACCESSIBILITY_STATE_NOT_SET;
            }
        }
        mPendingAccessibilityImportanceChange.clear();
    }
    ...
    int getAdapterPositionInRecyclerView(androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder) {
        if (viewHolder.hasAnyOfTheFlags(androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_INVALID
                | androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_REMOVED | androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_ADAPTER_POSITION_UNKNOWN)
                || !viewHolder.isBound()) {
     ...
     * {@link androidx.recyclerview.widget.RecyclerView}. Custom {@link androidx.recyclerview.widget.RecyclerView.LayoutManager layout managers} are encouraged
    ...
    public static class LayoutParams extends android.view.ViewGroup.MarginLayoutParams {
         ...
         * If you are calling from the context of an {@link androidx.recyclerview.widget.RecyclerView.Adapter},
         * use {@link #getBindingAdapterPosition()}. If you need the position that
         * {@link androidx.recyclerview.widget.RecyclerView} sees, use {@link #getAbsoluteAdapterPosition()}.
         */
        @Deprecated
         ...
         * corresponds to in the {@link androidx.recyclerview.widget.RecyclerView}. If the {@link androidx.recyclerview.widget.RecyclerView} has an
         * {@link androidx.recyclerview.widget.RecyclerView.Adapter} that merges other adapters, this position will be with respect to the
         * adapter that is assigned to the {@link androidx.recyclerview.widget.RecyclerView}.
         *
         * @return the up-to-date adapter position this view with respect to the RecyclerView. It
         * may return {@link androidx.recyclerview.widget.RecyclerView#NO_POSITION} if item represented by this View has been
         * removed or
        ...
        /**
         * Returns the up-to-date adapter position that the view this LayoutParams is attached to
         * corresponds to with respect to the {@link androidx.recyclerview.widget.RecyclerView.Adapter} that bound this View.
         *
         * @return the up-to-date adapter position this view relative to the {@link androidx.recyclerview.widget.RecyclerView.Adapter} that
         * bound this View. It may return {@link androidx.recyclerview.widget.RecyclerView#NO_POSITION} if item represented by
    ...
    /**
     * Observer base class for watching changes to an {@link androidx.recyclerview.widget.RecyclerView.Adapter}.
     * See {@link androidx.recyclerview.widget.RecyclerView.Adapter#registerAdapterDataObserver(androidx.recyclerview.widget.RecyclerView.AdapterDataObserver)}.
     */
    public abstract static class AdapterDataObserver {
        ...
        /**
         * Called when the {@link androidx.recyclerview.widget.RecyclerView.Adapter.StateRestorationPolicy} of the {@link androidx.recyclerview.widget.RecyclerView.Adapter} changed.
         * When this method is called, the Adapter might be ready to restore its state if it has
         * not already been restored.
         *
         * @see androidx.recyclerview.widget.RecyclerView.Adapter#getStateRestorationPolicy()
         * @see androidx.recyclerview.widget.RecyclerView.Adapter#setStateRestorationPolicy(androidx.recyclerview.widget.RecyclerView.Adapter.StateRestorationPolicy)
         */
        public void onStateRestorationPolicyChanged() {
            // do nothing
        }
     ...
     * instance for each call to {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#startSmoothScroll(androidx.recyclerview.widget.RecyclerView.SmoothScroller)}.
     *
     * @see LinearSmoothScroller
     */
    public abstract static class SmoothScroller {

        private int mTargetPosition = androidx.recyclerview.widget.RecyclerView.NO_POSITION;
        ...
        public SmoothScroller() {
            mRecyclingAction = new androidx.recyclerview.widget.RecyclerView.SmoothScroller.Action(0, 0);
        }

        /**
         * Starts a smooth scroll for the given target position.
         * <p>In each animation step, {@link androidx.recyclerview.widget.RecyclerView} will check
         * for the target view and call either
         * {@link #onTargetFound(android.view.View, androidx.recyclerview.widget.RecyclerView.State, androidx.recyclerview.widget.RecyclerView.SmoothScroller.Action)} or
         * {@link #onSeekTargetStep(int, int, androidx.recyclerview.widget.RecyclerView.State, androidx.recyclerview.widget.RecyclerView.SmoothScroller.Action)} until
        ...
        void start(androidx.recyclerview.widget.RecyclerView recyclerView, androidx.recyclerview.widget.RecyclerView.LayoutManager layoutManager) {
            ...
            if (mTargetPosition == androidx.recyclerview.widget.RecyclerView.NO_POSITION) {
        ...
        public PointF computeScrollVectorForPosition(int targetPosition) {
            ...
            if (layoutManager instanceof androidx.recyclerview.widget.RecyclerView.SmoothScroller.ScrollVectorProvider) {
                return ((androidx.recyclerview.widget.RecyclerView.SmoothScroller.ScrollVectorProvider) layoutManager)
                        .computeScrollVectorForPosition(targetPosition);
            }
            Log.w(TAG, "You should override computeScrollVectorForPosition when the LayoutManager"
                    + " does not implement " + androidx.recyclerview.widget.RecyclerView.SmoothScroller.ScrollVectorProvider.class.getCanonicalName());
            return null;
        }
         ...
         * cancel any existing {@link androidx.recyclerview.widget.RecyclerView.SmoothScroller.Action} updated by
         * {@link #onTargetFound(android.view.View, androidx.recyclerview.widget.RecyclerView.State, androidx.recyclerview.widget.RecyclerView.SmoothScroller.Action)} or
         * {@link #onSeekTargetStep(int, int, androidx.recyclerview.widget.RecyclerView.State, androidx.recyclerview.widget.RecyclerView.SmoothScroller.Action)}.
         */
        protected final void stop() {
            ...
            mRunning = false;
            onStop();
            mRecyclerView.mState.mTargetPosition = androidx.recyclerview.widget.RecyclerView.NO_POSITION;
            mTargetView = null;
            mTargetPosition = androidx.recyclerview.widget.RecyclerView.NO_POSITION;
         ...
         * {@link androidx.recyclerview.widget.RecyclerView#NO_POSITION} if no target view is set.
         */
        ...
        void onAnimation(int dx, int dy) {
            final androidx.recyclerview.widget.RecyclerView recyclerView = mRecyclerView;
            if (mTargetPosition == androidx.recyclerview.widget.RecyclerView.NO_POSITION || recyclerView == null) {
                stop();
            }
        ...
        /**
         * @see androidx.recyclerview.widget.RecyclerView#getChildLayoutPosition(android.view.View)
         */
        ...
        /**
         * @see androidx.recyclerview.widget.RecyclerView.LayoutManager#getChildCount()
         */
        public int getChildCount() {
        ...
        /**
         * @see androidx.recyclerview.widget.RecyclerView.LayoutManager#findViewByPosition(int)
         */
        public View findViewByPosition(int position) {
        ...
        /**
         * @see androidx.recyclerview.widget.RecyclerView#scrollToPosition(int)
         * @deprecated Use {@link androidx.recyclerview.widget.RecyclerView.SmoothScroller.Action#jumpTo(int)}.
         */
        @Deprecated
         ...
         * provided {@link androidx.recyclerview.widget.RecyclerView.SmoothScroller.Action} to define the next scroll.</p>
         *
         ...
         *               update this object.
         */
        protected abstract void onSeekTargetStep(@Px int dx, @Px int dy, @NonNull androidx.recyclerview.widget.RecyclerView.State state,
                                                 @NonNull androidx.recyclerview.widget.RecyclerView.SmoothScroller.Action action);

        /**
         * Called when the target position is laid out. This is the last callback SmoothScroller
         * will receive and it should update the provided {@link androidx.recyclerview.widget.RecyclerView.SmoothScroller.Action} to define the scroll
         ...
         */
        protected abstract void onTargetFound(@NonNull View targetView, @NonNull androidx.recyclerview.widget.RecyclerView.State state,
                                              @NonNull androidx.recyclerview.widget.RecyclerView.SmoothScroller.Action action);

        /**
         * Holds information about a smooth scroll request by a {@link androidx.recyclerview.widget.RecyclerView.SmoothScroller}.
         */
        public static class Action {

            public static final int UNDEFINED_DURATION = androidx.recyclerview.widget.RecyclerView.UNDEFINED_DURATION;
        ...
        /**
         * An interface which is optionally implemented by custom {@link androidx.recyclerview.widget.RecyclerView.LayoutManager}
         * to provide a hint to a {@link androidx.recyclerview.widget.RecyclerView.SmoothScroller} about the location of the target position.
         */
    ...
    static class AdapterDataObservable extends Observable<androidx.recyclerview.widget.RecyclerView.AdapterDataObserver> {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        SavedState(Parcel in, ClassLoader loader) {
            ...
            mLayoutState = in.readParcelable(
                    loader != null ? loader : androidx.recyclerview.widget.RecyclerView.LayoutManager.class.getClassLoader());
        }
        ...
        void copyFrom(androidx.recyclerview.widget.RecyclerView.SavedState other) {
            mLayoutState = other.mLayoutState;
        }

        public static final Creator<androidx.recyclerview.widget.RecyclerView.SavedState> CREATOR = new ClassLoaderCreator<androidx.recyclerview.widget.RecyclerView.SavedState>() {
            @Override
            public androidx.recyclerview.widget.RecyclerView.SavedState createFromParcel(Parcel in, ClassLoader loader) {
                return new androidx.recyclerview.widget.RecyclerView.SavedState(in, loader);
            }

            @Override
            public androidx.recyclerview.widget.RecyclerView.SavedState createFromParcel(Parcel in) {
                return new androidx.recyclerview.widget.RecyclerView.SavedState(in, null);
            }

            @Override
            public androidx.recyclerview.widget.RecyclerView.SavedState[] newArray(int size) {
                return new androidx.recyclerview.widget.RecyclerView.SavedState[size];
            }
        };
    }
    ...
    public static class State {
        ...
        int mTargetPosition = androidx.recyclerview.widget.RecyclerView.NO_POSITION;
        ...
        /**
         * True if the associated {@link androidx.recyclerview.widget.RecyclerView} is in the pre-layout step where it is having
         * its {@link androidx.recyclerview.widget.RecyclerView.LayoutManager} layout items where they will be at the beginning of a set of
         ...
         * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#onLayoutChildren(androidx.recyclerview.widget.RecyclerView.Recycler, androidx.recyclerview.widget.RecyclerView.State)} when this happens.
         *
        ...
        /**
         * Returns true if the {@link androidx.recyclerview.widget.RecyclerView} is in the pre-layout step where it is having its
         * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager} layout items where they will be at the beginning of a set of
         * predictive item animations.
         */
         ...
         * {@link androidx.recyclerview.widget.RecyclerView#NO_POSITION} if there is no target
         * position.
         */
        ...
        public boolean hasTargetScrollPosition() {
            return mTargetPosition != androidx.recyclerview.widget.RecyclerView.NO_POSITION;
        }
         ...
         * scenes, RecyclerView offsets {@link androidx.recyclerview.widget.RecyclerView.Recycler#getViewForPosition(int)} calls such that
         ...
         * <p>
         * You can get the adapter's item count via {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#getItemCount()} method.
         *
         * @return The number of items currently available
         * @see androidx.recyclerview.widget.RecyclerView.LayoutManager#getItemCount()
         */
        public int getItemCount() {
            return mInPreLayout
     ...
     * <p>
     * Subclasses of {@link androidx.recyclerview.widget.RecyclerView.OnFlingListener} can be used to implement custom fling behavior.
     *
     * @see #setOnFlingListener(androidx.recyclerview.widget.RecyclerView.OnFlingListener)
     */
    public abstract static class OnFlingListener {

        /**
         * Override this to handle a fling given the velocities in both x and y directions.
         * Note that this method will only be called if the associated {@link androidx.recyclerview.widget.RecyclerView.LayoutManager}
    ...
    private class ItemAnimatorRestoreListener implements androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemAnimatorListener {
        ...
        @Override
        public void onAnimationFinished(androidx.recyclerview.widget.RecyclerView.ViewHolder item) {
     ...
     * are being animated, but implementors must call {@link #dispatchAnimationFinished(androidx.recyclerview.widget.RecyclerView.ViewHolder)}
     * when a ViewHolder's animation is finished. In other words, there must be a matching
     * {@link #dispatchAnimationFinished(androidx.recyclerview.widget.RecyclerView.ViewHolder)} call for each
     * {@link #animateAppearance(androidx.recyclerview.widget.RecyclerView.ViewHolder, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo) animateAppearance()},
     * {@link #animateChange(androidx.recyclerview.widget.RecyclerView.ViewHolder, androidx.recyclerview.widget.RecyclerView.ViewHolder, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo)
     * animateChange()}
     * {@link #animatePersistence(androidx.recyclerview.widget.RecyclerView.ViewHolder, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo) animatePersistence()},
     * and
     * {@link #animateDisappearance(androidx.recyclerview.widget.RecyclerView.ViewHolder, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo)
     * animateDisappearance()} call.
     *
     * <p>By default, RecyclerView uses {@link DefaultItemAnimator}.</p>
     *
     * @see #setItemAnimator(androidx.recyclerview.widget.RecyclerView.ItemAnimator)
     */
    ...
    public abstract static class ItemAnimator {
         ...
         * <p>
         *
         * @see #recordPreLayoutInformation(androidx.recyclerview.widget.RecyclerView.State, androidx.recyclerview.widget.RecyclerView.ViewHolder, int, List)
         */
        public static final int FLAG_CHANGED = androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_UPDATE;
         ...
         * @see #recordPreLayoutInformation(androidx.recyclerview.widget.RecyclerView.State, androidx.recyclerview.widget.RecyclerView.ViewHolder, int, List)
         */
        public static final int FLAG_REMOVED = androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_REMOVED;

        /**
         * Adapter {@link androidx.recyclerview.widget.RecyclerView.Adapter#notifyDataSetChanged()} has been called and the content
         * represented by this ViewHolder is invalid.
         * <p>
         *
         * @see #recordPreLayoutInformation(androidx.recyclerview.widget.RecyclerView.State, androidx.recyclerview.widget.RecyclerView.ViewHolder, int, List)
         */
        public static final int FLAG_INVALIDATED = androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_INVALID;

        /**
         * The position of the Item represented by this ViewHolder has been changed. This flag is
         * not bound to {@link androidx.recyclerview.widget.RecyclerView.Adapter#notifyItemMoved(int, int)}. It might be set in response to
         ...
         * @see #recordPreLayoutInformation(androidx.recyclerview.widget.RecyclerView.State, androidx.recyclerview.widget.RecyclerView.ViewHolder, int, List)
         */
        public static final int FLAG_MOVED = androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_MOVED;

        /**
         * This ViewHolder was not laid out but has been added to the layout in pre-layout state
         * by the {@link androidx.recyclerview.widget.RecyclerView.LayoutManager}. This means that the item was already in the Adapter but
        ...
        public static final int FLAG_APPEARED_IN_PRE_LAYOUT =
                androidx.recyclerview.widget.RecyclerView.ViewHolder.FLAG_APPEARED_IN_PRE_LAYOUT;

        /**
         * The set of flags that might be passed to
         * {@link #recordPreLayoutInformation(androidx.recyclerview.widget.RecyclerView.State, androidx.recyclerview.widget.RecyclerView.ViewHolder, int, List)}.
         */
        @IntDef(flag = true, value = {
        ...
        private ArrayList<androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemAnimatorFinishedListener> mFinishedListeners =
                new ArrayList<androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemAnimatorFinishedListener>();
         ...
         */
        void setListener(androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemAnimatorListener listener) {
            mListener = listener;
        }
         ...
         * <p>
         * The default implementation returns an {@link androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo} which holds the bounds of
         ...
         *                    {@link androidx.recyclerview.widget.RecyclerView.Adapter#notifyItemChanged(int, Object)} or
         *                    {@link androidx.recyclerview.widget.RecyclerView.Adapter#notifyItemRangeChanged(int, int, Object)}.
         ...
         * @see #recordPostLayoutInformation(androidx.recyclerview.widget.RecyclerView.State, androidx.recyclerview.widget.RecyclerView.ViewHolder)
         * @see #animateAppearance(androidx.recyclerview.widget.RecyclerView.ViewHolder, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo)
         * @see #animateDisappearance(androidx.recyclerview.widget.RecyclerView.ViewHolder, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo)
         * @see #animateChange(androidx.recyclerview.widget.RecyclerView.ViewHolder, androidx.recyclerview.widget.RecyclerView.ViewHolder, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo)
         * @see #animatePersistence(androidx.recyclerview.widget.RecyclerView.ViewHolder, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo)
         */
        public @NonNull
        androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo recordPreLayoutInformation(@NonNull androidx.recyclerview.widget.RecyclerView.State state,
                                                                                                         @NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder, @androidx.recyclerview.widget.RecyclerView.ItemAnimator.AdapterChanges int changeFlags,
                                                                                                         @NonNull List<Object> payloads) {
         ...
         */
        public @NonNull
        androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo recordPostLayoutInformation(@NonNull androidx.recyclerview.widget.RecyclerView.State state,
                                                                                                          @NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder) {
            return obtainHolderInfo().setFrom(viewHolder);
        }
         ...
         * {@link #canReuseUpdatedViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder) canReuseUpdatedViewHolder} and the
         ...
         * RecyclerView will call {@link #recordPostLayoutInformation(androidx.recyclerview.widget.RecyclerView.State, androidx.recyclerview.widget.RecyclerView.ViewHolder)} and the
         * response of that call will be passed to this method as the <code>postLayoutInfo</code>.
         * <p>
         * ItemAnimator must call {@link #dispatchAnimationFinished(androidx.recyclerview.widget.RecyclerView.ViewHolder)} when the animation
         * is complete (or instantly call {@link #dispatchAnimationFinished(androidx.recyclerview.widget.RecyclerView.ViewHolder)} if it
         ...
         *                       {@link #recordPostLayoutInformation(androidx.recyclerview.widget.RecyclerView.State, androidx.recyclerview.widget.RecyclerView.ViewHolder)}. Might be
         *                       null if the LayoutManager did not layout the item.
         * @return true if a later call to {@link #runPendingAnimations()} is requested,
         * false otherwise.
         */
        public abstract boolean animateDisappearance(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder,
                                                     @NonNull androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo preLayoutInfo, @Nullable androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo postLayoutInfo);
         ...
         *                       #recordPreLayoutInformation(androidx.recyclerview.widget.RecyclerView.State, androidx.recyclerview.widget.RecyclerView.ViewHolder, int, List)}.
         * @return true if a later call to {@link #runPendingAnimations()} is requested,
         * false otherwise.
         */
        public abstract boolean animateAppearance(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder,
                                                  @Nullable androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo preLayoutInfo, @NonNull androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo postLayoutInfo);

        /**
         * Called by the RecyclerView when a ViewHolder is present in both before and after the
         * layout and RecyclerView has not received a {@link androidx.recyclerview.widget.RecyclerView.Adapter#notifyItemChanged(int)} call
         * for it or a {@link androidx.recyclerview.widget.RecyclerView.Adapter#notifyDataSetChanged()} call.
         * <p>
         ...
         * animate, it should call {@link #dispatchAnimationFinished(androidx.recyclerview.widget.RecyclerView.ViewHolder)} and return
         * <code>false</code>.
         * <p>
         * ItemAnimator must call {@link #dispatchAnimationFinished(androidx.recyclerview.widget.RecyclerView.ViewHolder)} when the animation
         * is complete (or instantly call {@link #dispatchAnimationFinished(androidx.recyclerview.widget.RecyclerView.ViewHolder)} if it
         ...
         * false otherwise.
         */
        public abstract boolean animatePersistence(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder,
                                                   @NonNull androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo preLayoutInfo, @NonNull androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo postLayoutInfo);

        /**
         * Called by the RecyclerView when an adapter item is present both before and after the
         * layout and RecyclerView has received a {@link androidx.recyclerview.widget.RecyclerView.Adapter#notifyItemChanged(int)} call
         * for it. This method may also be called when
         * {@link androidx.recyclerview.widget.RecyclerView.Adapter#notifyDataSetChanged()} is called and adapter has stable ids so that
         * RecyclerView could still rebind views to the same ViewHolders. If viewType changes when
         * {@link androidx.recyclerview.widget.RecyclerView.Adapter#notifyDataSetChanged()} is called, this method <b>will not</b> be called,
         * instead, {@link #animateAppearance(androidx.recyclerview.widget.RecyclerView.ViewHolder, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo)} will be
         * called for the new ViewHolder and the old one will be recycled.
         * <p>
         * If this method is called due to a {@link androidx.recyclerview.widget.RecyclerView.Adapter#notifyDataSetChanged()} call, there is
         ...
         * presentation (see: {@link #canReuseUpdatedViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder, List)}.
         ...
         * <p>
         * When {@link androidx.recyclerview.widget.RecyclerView.Adapter#notifyItemChanged(int)} is called, the Item's view type may change.
         * If the Item's view type has changed or ItemAnimator returned <code>false</code> for
         * this ViewHolder when {@link #canReuseUpdatedViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder, List)} was called, the
         ...
         * <p>
         * ItemAnimator must call {@link #dispatchAnimationFinished(androidx.recyclerview.widget.RecyclerView.ViewHolder)} for each distinct
         * ViewHolder when their animation is complete
         * (or instantly call {@link #dispatchAnimationFinished(androidx.recyclerview.widget.RecyclerView.ViewHolder)} if it decides not to
         * animate the view).
         * <p>
         * If oldHolder and newHolder are the same instance, you should call
         * {@link #dispatchAnimationFinished(androidx.recyclerview.widget.RecyclerView.ViewHolder)} <b>only once</b>.
         * <p>
         * Note that when a ViewHolder both changes and disappears in the same layout pass, the
         * animation callback method which will be called by the RecyclerView depends on the
         * ItemAnimator's decision whether to re-use the same ViewHolder or not, and also the
         ...
         * false otherwise.
         */
        public abstract boolean animateChange(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder oldHolder,
                                              @NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder newHolder,
                                              @NonNull androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo preLayoutInfo, @NonNull androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo postLayoutInfo);
         ...
         * {@link #animateAppearance(androidx.recyclerview.widget.RecyclerView.ViewHolder, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo)
         * animateAppearance()},
         * {@link #animateChange(androidx.recyclerview.widget.RecyclerView.ViewHolder, androidx.recyclerview.widget.RecyclerView.ViewHolder, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo)
         * animateChange()}
         * {@link #animatePersistence(androidx.recyclerview.widget.RecyclerView.ViewHolder, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo)
         ...
         * Also, {@link #dispatchAnimationFinished(androidx.recyclerview.widget.RecyclerView.ViewHolder)} should be called for each finished
         ...
         */
        public abstract void endAnimation(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder item);
         ...
         * should
         * be a matching {@link #dispatchAnimationFinished(androidx.recyclerview.widget.RecyclerView.ViewHolder)} call by the subclass.
         * <p>
         * For {@link #animateChange(androidx.recyclerview.widget.RecyclerView.ViewHolder, androidx.recyclerview.widget.RecyclerView.ViewHolder, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo)
         ...
         * @see #onAnimationFinished(androidx.recyclerview.widget.RecyclerView.ViewHolder)
         */
        public final void dispatchAnimationFinished(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder) {
        ...
        /**
         * Called after {@link #dispatchAnimationFinished(androidx.recyclerview.widget.RecyclerView.ViewHolder)} is called by the
         * ItemAnimator.
         *
         ...
         * @see #dispatchAnimationFinished(androidx.recyclerview.widget.RecyclerView.ViewHolder)
         */
        public void onAnimationFinished(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder) {
        }
         ...
         * {@link #dispatchAnimationStarted(androidx.recyclerview.widget.RecyclerView.ViewHolder)} call by the subclass.
         * <p>
         * For {@link #animateChange(androidx.recyclerview.widget.RecyclerView.ViewHolder, androidx.recyclerview.widget.RecyclerView.ViewHolder, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo)
         * animateChange()}, subclass should call this method for both the <code>oldHolder</code>
         * and <code>newHolder</code> (if they are not the same instance).
         ...
         * {@link #dispatchAnimationFinished(androidx.recyclerview.widget.RecyclerView.ViewHolder)} <b>without</b> calling
         * {@link #dispatchAnimationStarted(androidx.recyclerview.widget.RecyclerView.ViewHolder)}.
         *
         * @param viewHolder The ViewHolder whose animation is starting.
         * @see #onAnimationStarted(androidx.recyclerview.widget.RecyclerView.ViewHolder)
         */
        public final void dispatchAnimationStarted(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder) {
         ...
         * @see #dispatchAnimationStarted(androidx.recyclerview.widget.RecyclerView.ViewHolder)
         */
        public void onAnimationStarted(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder) {
         ...
         * @return true if there are any item animations currently running, false otherwise.
         */
        public final boolean isRunning(@Nullable androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemAnimatorFinishedListener listener) {
         ...
         * <p>
         * Note that this method will only be called if the {@link androidx.recyclerview.widget.RecyclerView.ViewHolder} still has the same
         * type ({@link androidx.recyclerview.widget.RecyclerView.Adapter#getItemViewType(int)}). Otherwise, ItemAnimator will always receive
         * both {@link androidx.recyclerview.widget.RecyclerView.ViewHolder}s in the
         * {@link #animateChange(androidx.recyclerview.widget.RecyclerView.ViewHolder, androidx.recyclerview.widget.RecyclerView.ViewHolder, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo)} method.
         * <p>
         * If your application is using change payloads, you can override
         * {@link #canReuseUpdatedViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder, List)} to decide based on payloads.
         *
         ...
         * @see #canReuseUpdatedViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder, List)
         */
        public boolean canReuseUpdatedViewHolder(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder) {
            return true;
        }
         ...
         *                   {@link androidx.recyclerview.widget.RecyclerView.Adapter#notifyDataSetChanged()}. The same list of
         ...
         * {@link #canReuseUpdatedViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder)}.
         * @see #canReuseUpdatedViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder)
         */
        public boolean canReuseUpdatedViewHolder(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder,
                                                 @NonNull List<Object> payloads) {
        ...
        /**
         * Returns a new {@link androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo} which will be used to store information about the
         * ViewHolder. This information will later be passed into <code>animate**</code> methods.
         * <p>
         * You can override this method if you want to extend {@link androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo} and provide
         * your own instances.
         *
         * @return A new {@link androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo}.
         */
        @NonNull
        ...
        interface ItemAnimatorListener {
            void onAnimationFinished(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder item);
        }
         ...
         *
         * @see #isRunning(androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemAnimatorFinishedListener)
         */
         ...
         * {@link #recordPreLayoutInformation(androidx.recyclerview.widget.RecyclerView.State, androidx.recyclerview.widget.RecyclerView.ViewHolder, int, List)} and
         * {@link #recordPostLayoutInformation(androidx.recyclerview.widget.RecyclerView.State, androidx.recyclerview.widget.RecyclerView.ViewHolder)} returns this data
        ...
        public static class ItemHolderInfo {
             ...
             * @return This {@link androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo}
             */
            @NonNull
            public androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo setFrom(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder holder) {
             ...
             *               {@link #recordPreLayoutInformation(androidx.recyclerview.widget.RecyclerView.State, androidx.recyclerview.widget.RecyclerView.ViewHolder, int,
             *               List)}.
             * @return This {@link androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo}
             */
            @NonNull
            public androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo setFrom(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder holder,
                                                                                                 @androidx.recyclerview.widget.RecyclerView.ItemAnimator.AdapterChanges int flags) {
    ...
    public interface ChildDrawingOrderCallback {
         ...
         * @see androidx.recyclerview.widget.RecyclerView#setChildDrawingOrderCallback(androidx.recyclerview.widget.RecyclerView.ChildDrawingOrderCallback)
         */
